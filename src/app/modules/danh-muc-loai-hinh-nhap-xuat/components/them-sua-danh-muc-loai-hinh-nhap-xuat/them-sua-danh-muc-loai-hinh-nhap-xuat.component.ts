...
@Component({
    selector: 'them-sua-danh-muc-loai-hinh-nhap-xuat',
    templateUrl: './them-sua-danh-muc-loai-hinh-nhap-xuat.component.html',
    styleUrls: ['./them-sua-danh-muc-loai-hinh-nhap-xuat.component.scss'],
})
export class ThemSuaDanhMucLoaiHinhNhapXuat implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucLoaiHinhNhapXuat>,
    ...
    get maLhinh() {
        return this.form.controls.maLhinh as FormControl;
    }
    get tenLhinh() {
        return this.form.controls.tenLhinh as FormControl;
    }
    get ghiChu() {
