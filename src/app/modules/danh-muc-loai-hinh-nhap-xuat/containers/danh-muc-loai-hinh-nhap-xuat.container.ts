...
import { DanhSachDanhMucLoaiHinhNhapXuat } from '../components';
import { DanhMucLoaiHinhNhapXuatService as DanhMucLoaiHinhNhapXuatService } from '../services';

@Component({
    selector: 'danh-muc-loai-hinh-nhap-xuat-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-loai-hinh-nhap-xuat
...
export class DanhMucLoaiHinhNhapXuatContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucLoaiHinhNhapXuat, { static: true })
    listUserForm: DanhSachDanhMucLoaiHinhNhapXuat;
    ...
    constructor(private service: DanhMucLoaiHinhNhapXuatService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
