...
import { DanhSachDanhMucLoaiHinhKhoTang } from '../components';
import { DanhMucLoaiHinhKhoTangService } from '../services';

@Component({
    selector: 'danh-muc-loai-hinh-kho-tang-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-loai-hinh-kho-tang
...
export class DanhMucLoaiHinhKhoTangContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucLoaiHinhKhoTang, { static: true })
    listUserForm: DanhSachDanhMucLoaiHinhKhoTang;
    ...
    constructor(private service: DanhMucLoaiHinhKhoTangService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
