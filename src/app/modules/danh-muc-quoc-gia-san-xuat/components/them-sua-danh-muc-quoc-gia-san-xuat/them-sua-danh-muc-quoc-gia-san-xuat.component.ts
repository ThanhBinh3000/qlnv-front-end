...
import { QuocGiaSanXuatModel } from '../..';

@Component({
    selector: 'them-sua-danh-muc-quoc-gia-san-xuat',
    templateUrl: './them-sua-danh-muc-quoc-gia-san-xuat.component.html',
    styleUrls: ['./them-sua-danh-muc-quoc-gia-san-xuat.component.scss'],
})
export class ThemSuaDanhMucQuocGiaSanXuat implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucQuocGiaSanXuat>,
        ...
        public data: QuocGiaSanXuatModel,
    ) {
    }
    ...
    ngOnInit(): void {
        ...
        if(this.data.id == null || this.data.id > 0) {
            this.form = this.fb.group({
                maQgia: new FormControl('', {}),
                tenQgia: new FormControl('', {}),
            ...
            this.form = this.fb.group({
                maQgia: new FormControl(this.data.maQgia),
                tenQgia: new FormControl(this.data.tenQgia),
