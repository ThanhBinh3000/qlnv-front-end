...
import { DanhSachDanhMucQuocGiaSanXuat } from '../components';
import { DanhMucQuocGiaSanXuatService } from '../services';

@Component({
    selector: 'danh-muc-quoc-gia-san-xuat-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-quoc-gia-san-xuat
...
export class DanhMucQuocGiaSanXuatContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucQuocGiaSanXuat, { static: true })
    listUserForm: DanhSachDanhMucQuocGiaSanXuat;
    ...
    constructor(private service: DanhMucQuocGiaSanXuatService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
