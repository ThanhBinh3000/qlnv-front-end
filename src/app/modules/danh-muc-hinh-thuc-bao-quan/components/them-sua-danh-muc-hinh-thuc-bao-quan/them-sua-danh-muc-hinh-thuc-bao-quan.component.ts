...
import { HinhThucBaoQuanModel } from '../..';

@Component({
    selector: 'them-sua-danh-muc-hinh-thuc-bao-quan',
    templateUrl: './them-sua-danh-muc-hinh-thuc-bao-quan.component.html',
    styleUrls: ['./them-sua-danh-muc-hinh-thuc-bao-quan.component.scss'],
})
export class ThemSuaDanhMucHinhThucBaoQuan implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucHinhThucBaoQuan>,
        ...
        public data: HinhThucBaoQuanModel,
    ) {
    }
    ...
    ngOnInit(): void {
        ...
        if(this.data.id == null || this.data.id > 0) {
            this.form = this.fb.group({
                maTtrang: new FormControl('', {}),
                tenTtrang: new FormControl('', {}),
            ...
            this.form = this.fb.group({
                maTtrang: new FormControl(this.data.maTtrang),
                tenTtrang: new FormControl(this.data.tenTtrang),
