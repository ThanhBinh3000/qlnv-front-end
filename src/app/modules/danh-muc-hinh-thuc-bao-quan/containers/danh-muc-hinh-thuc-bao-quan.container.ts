...
import { DanhSachDanhMucHinhThucBaoQuan } from '../components';
import { DanhMucHinhThucBaoQuanService } from '../services';

@Component({
    selector: 'danh-muc-hinh-thuc-bao-quan-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-hinh-thuc-bao-quan
...
export class DanhMucHinhThucBaoQuanContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucHinhThucBaoQuan, { static: true })
    listUserForm: DanhSachDanhMucHinhThucBaoQuan;
    ...
    constructor(private service: DanhMucHinhThucBaoQuanService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
