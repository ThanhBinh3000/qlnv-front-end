...
import { QL_Danh_Muc_Hang_DTQG_API_TOKEN, DanhMucHangDTQGModel } from '../types';

const TRANSACTION_NAME = environment.elasticAPM.transactionName;

@Injectable()
export class QuanLyDanhMucHangDTQGService {
    ...
    constructor(@Inject(QL_Danh_Muc_Hang_DTQG_API_TOKEN) private apiConstant: ApiConstant, private httpClient: HttpClient) { }
    ...
    createNewUser(input: DanhMucHangDTQGModel, options: PaginateOptions){
    ...
    updateUser(input: DanhMucHangDTQGModel, options: PaginateOptions, userid: string){
