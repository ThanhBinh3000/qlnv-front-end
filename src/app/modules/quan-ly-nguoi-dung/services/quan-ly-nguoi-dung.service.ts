...
export class QuanLyNguoiDungService {
    ...
    constructor(@Inject(QL_Nguoi_Dung_API_TOKEN) private apiConstant: ApiConstant, private httpClient: HttpClient) { }
    ...
    createNewUser(input: NguoiDungModel, options: PaginateOptions){
    ...
    updateUser(input: NguoiDungModel, options: PaginateOptions, userid: string){
