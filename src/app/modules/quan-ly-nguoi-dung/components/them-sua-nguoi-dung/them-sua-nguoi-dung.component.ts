...
@Component({
    selector: 'them-sua-nguoi-dung',
    templateUrl: './them-sua-nguoi-dung.component.html',
    styleUrls: ['./them-sua-nguoi-dung.component.scss'],
})
export class ThemSuaNguoiDung implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaNguoiDung>,
        private breakpointObserver: BreakpointObserver,
        private service: QuanLyNguoiDungService,
