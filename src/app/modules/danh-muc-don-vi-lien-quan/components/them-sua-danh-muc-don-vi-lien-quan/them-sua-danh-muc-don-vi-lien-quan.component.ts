...
import { DonViLienQuanModel } from '../..';

@Component({
    selector: 'them-sua-danh-muc-don-vi-lien-quan',
    templateUrl: './them-sua-danh-muc-don-vi-lien-quan.component.html',
    styleUrls: ['./them-sua-danh-muc-don-vi-lien-quan.component.scss'],
})
export class ThemSuaDanhMucDonViLienQuan implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucDonViLienQuan>,
        ...
        public data: DonViLienQuanModel,
    ) {
    }
