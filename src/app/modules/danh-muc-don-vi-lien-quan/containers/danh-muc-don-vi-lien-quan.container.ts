...
import { DanhSachDanhMucDonViLienQuan } from '../components';
import { DanhMucDonViLienQuanService } from '../services';

@Component({
    selector: 'danh-muc-don-vi-lien-quan-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-don-vi-lien-quan
...
export class DanhMucDonViLienQuanContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucDonViLienQuan, { static: true })
    listUserForm: DanhSachDanhMucDonViLienQuan;
    ...
    constructor(private service: DanhMucDonViLienQuanService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
