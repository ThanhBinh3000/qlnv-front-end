...
import { LoaiHinhBaoQuanModel } from '../..';

@Component({
    selector: 'them-sua-danh-muc-loai-hinh-bao-quan',
    templateUrl: './them-sua-danh-muc-loai-hinh-bao-quan.component.html',
    styleUrls: ['./them-sua-danh-muc-loai-hinh-bao-quan.component.scss'],
})
export class ThemSuaDanhMucLoaiHinhBaoQuan implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucLoaiHinhBaoQuan>,
        private breakpointObserver: BreakpointObserver,
        private service: DanhMucLoaiHinhBaoQuanService,
        private spinner: NgxSpinnerService,
        private dialog: MatDialog,
        @Inject(MAT_DIALOG_DATA)
        public data: LoaiHinhBaoQuanModel,
    ) {
    }
    ...
    ngOnInit(): void {
        ...
        if(this.data.id == null || this.data.id > 0) {
            this.form = this.fb.group({
                maLhinh: new FormControl('', {}),
                tenLhinh: new FormControl('', {}),
            ...
            this.form = this.fb.group({
                maLhinh: new FormControl(this.data.maLhinh),
                tenLhinh: new FormControl(this.data.tenLhinh),
