...
import { DanhSachDanhMucKyBaoQuan } from '../components';
import { DanhMucKyBaoQuanService } from '../services';

@Component({
    selector: 'danh-muc-ky-bao-quan-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-ky-bao-quan
...
export class DanhMucKyBaoQuanContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucKyBaoQuan, { static: true })
    listUserForm: DanhSachDanhMucKyBaoQuan;
    ...
    constructor(private service: DanhMucKyBaoQuanService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
