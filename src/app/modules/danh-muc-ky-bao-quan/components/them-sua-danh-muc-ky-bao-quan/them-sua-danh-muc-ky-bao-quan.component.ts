...
@Component({
    selector: 'them-sua-danh-muc-ky-bao-quan',
    templateUrl: './them-sua-danh-muc-ky-bao-quan.component.html',
    styleUrls: ['./them-sua-danh-muc-ky-bao-quan.component.scss'],
})
export class ThemSuaDanhMucKyBaoQuan implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucKyBaoQuan>,
    ...
    ngOnInit(): void {
        ...
        if(this.data.id == null || this.data.id > 0) {
            this.form = this.fb.group({
                maKy: new FormControl('', {}),
                tenKy: new FormControl('', {}),
            ...
            this.form = this.fb.group({
                maKy: new FormControl(this.data.maKy),
                tenKy: new FormControl(this.data.tenKy),
    ...
    get maKy() {
        return this.form.controls.maKy as FormControl;
    }
    get tenKy() {
        return this.form.controls.tenKy as FormControl;
    }
    get ghiChu() {
