...
import { AdminAccountInfo } from '../../user-settings-types';
...
export class AdminUserComponent implements OnInit, OnDestroy {
    ...
    originAccountInfo: AdminAccountInfo;
    ...
    ngOnInit(): void {
        ...
        this.myAccountService
            ...
            .pipe(
                ...
                map(res => {
                    this.originAccountInfo = res as AdminAccountInfo;
    ...
    bindFormValues(info: AdminAccountInfo) {
        if (info) {
