...
import { DanhSachDanhMucKeLot } from '../components';
import { DanhMucKeLotService } from '../services';

@Component({
    selector: 'danh-muc-ke-lot-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-ke-lot
...
export class DanhMucKeLotContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucKeLot, { static: true })
    listUserForm: DanhSachDanhMucKeLot;
    ...
    constructor(private service: DanhMucKeLotService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
