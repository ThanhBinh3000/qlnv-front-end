...
import { TinhTrangGoiThauModel } from '../..';

@Component({
    selector: 'them-sua-danh-muc-tinh-trang-goi-thau',
    templateUrl: './them-sua-danh-muc-tinh-trang-goi-thau.component.html',
    styleUrls: ['./them-sua-danh-muc-tinh-trang-goi-thau.component.scss'],
})
export class ThemSuaDanhMucTinhTrangGoiThau implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucTinhTrangGoiThau>,
        ...
        public data: TinhTrangGoiThauModel,
    ) {
    }
