...
import { DanhSachDanhMucTinhTrangGoiThau } from '../components';
import { DanhMucTinhTrangGoiThauService } from '../services';

@Component({
    selector: 'danh-muc-tinh-trang-goi-thau-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-tinh-trang-goi-thau
...
export class DanhMucTinhTrangGoiThauContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucTinhTrangGoiThau, { static: true })
    listUserForm: DanhSachDanhMucTinhTrangGoiThau;
    ...
    constructor(private service: DanhMucTinhTrangGoiThauService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
