...
import { TinhTrangGoiThauModel } from '../types';

// const TRANSACTION_NAME = environment.elasticAPM.transactionName;

@Injectable()
export class DanhMucTinhTrangGoiThauService {
    ...
    private paginateByUserRole(
        ...
        optionSearch?: TinhTrangGoiThauModel
    ) {
        let params;
    ...
    create(input: TinhTrangGoiThauModel, options: PaginateOptions){
        const headers = new HttpHeaders();
        return this.httpClient
            .post<any>(
    ...
    update(input: TinhTrangGoiThauModel, options: PaginateOptions){
        const headers = new HttpHeaders();
        return this.httpClient
            .post<any>(
