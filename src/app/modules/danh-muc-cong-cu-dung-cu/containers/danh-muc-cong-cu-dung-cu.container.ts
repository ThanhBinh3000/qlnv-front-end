...
import { DanhSachDanhMucCongCuDungCu } from '../components';
import { DanhMucCongCuDungCuService } from '../services';

@Component({
    selector: 'danh-muc-cong-cu-dung-cu-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-cong-cu-dung-cu
...
export class DanhMucCongCuDungCuContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucCongCuDungCu, { static: true })
    listUserForm: DanhSachDanhMucCongCuDungCu;
    ...
    constructor(private service: DanhMucCongCuDungCuService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
