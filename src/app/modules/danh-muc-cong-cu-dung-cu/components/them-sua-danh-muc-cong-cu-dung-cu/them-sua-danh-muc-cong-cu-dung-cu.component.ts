...
@Component({
    selector: 'them-sua-danh-muc-cong-cu-dung-cu',
    templateUrl: './them-sua-danh-muc-cong-cu-dung-cu.component.html',
    styleUrls: ['./them-sua-danh-muc-cong-cu-dung-cu.component.scss'],
})
export class ThemSuaDanhMucCongCuDungCu implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucCongCuDungCu>,
        private breakpointObserver: BreakpointObserver,
        private service: DanhMucCongCuDungCuService,
        private spinner: NgxSpinnerService,
        private dialog: MatDialog,
        private cdr: ChangeDetectorRef,
        private donViTinhService: DanhMucDonViTinhService,
    ...
    ngOnInit(): void {
        ...
        if(this.data.id == null || this.data.id > 0) {
            ...
            this.form = this.fb.group({
                maCcu: new FormControl(this.data.maCcu),
                tenCcu: new FormControl(this.data.tenCcu),
    ...
    get maCcu() {
        return this.form.controls.maCcu as FormControl;
    }
    get tenCcu() {
        return this.form.controls.tenCcu as FormControl;
    }
    get ghiChu() {
    ...
    loadDanhSachDonViTinh() {
        this.donViTinhService.getAll().subscribe(donViTinhs=>{
            this.donViTinhList = donViTinhs.data;
        })
    }
}
