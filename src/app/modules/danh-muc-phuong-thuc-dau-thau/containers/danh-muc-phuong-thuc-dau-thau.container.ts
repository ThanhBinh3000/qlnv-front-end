...
import { DanhSachDanhMucPhuongThucDauThau } from '../components';
import { DanhMucPhuongThucDauThauService } from '../services';

@Component({
    selector: 'danh-muc-phuong-thuc-dau-thau-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-phuong-thuc-dau-thau
...
export class DanhMucPhuongThucDauThauContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucPhuongThucDauThau, { static: true })
    listUserForm: DanhSachDanhMucPhuongThucDauThau;
    ...
    constructor(private service: DanhMucPhuongThucDauThauService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
