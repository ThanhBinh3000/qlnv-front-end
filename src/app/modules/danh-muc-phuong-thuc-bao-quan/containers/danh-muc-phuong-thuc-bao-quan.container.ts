...
import { DanhSachDanhMucPhuongThucBaoQuan } from '../components';
import { DanhMucPhuongThucBaoQuanService } from '../services';

@Component({
    selector: 'danh-muc-phuong-thuc-bao-quan-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-phuong-thuc-bao-quan
...
export class DanhMucPhuongThucBaoQuanContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucPhuongThucBaoQuan, { static: true })
    listUserForm: DanhSachDanhMucPhuongThucBaoQuan;
    ...
    constructor(private service: DanhMucPhuongThucBaoQuanService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
