...
@Component({
    selector: 'them-sua-danh-muc-phuong-thuc-bao-quan',
    templateUrl: './them-sua-danh-muc-phuong-thuc-bao-quan.component.html',
    styleUrls: ['./them-sua-danh-muc-phuong-thuc-bao-quan.component.scss'],
})
export class ThemSuaDanhMucPhuongThucBaoQuan implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucPhuongThucBaoQuan>,
    ...
    get maPthuc() {
        return this.form.controls.maPthuc as FormControl;
    }
    get tenPthuc() {
        return this.form.controls.tenPthuc as FormControl;
    }
    get ghiChu() {
