...
import { ThemSuaDanhMucPhuongXa } from '../them-sua-danh-muc-phuong-xa/them-sua-danh-muc-phuong-xa.component';

@Component({
    selector: 'danh-sach-danh-muc-phuong-xa',
    templateUrl: './danh-sach-danh-muc-phuong-xa.component.html',
    styleUrls: ['./danh-sach-danh-muc-phuong-xa.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DanhSachDanhMucPhuongXa implements OnInit, OnDestroy, OnChanges, AfterViewInit {
    @Input()
    userCollection: any;
    ...
    commonFunc(element: any, isView: boolean) {
        const termDialog = this.dialog.open(ThemSuaDanhMucPhuongXa, {
            width: '450px',
            data: {
        ...
        this.config = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    label: 'Quận huyện',
                    fieldName: 'cap',
                    actionFunction: this.getQuanHuyen.bind(this),
                    templateFunction: () => {
