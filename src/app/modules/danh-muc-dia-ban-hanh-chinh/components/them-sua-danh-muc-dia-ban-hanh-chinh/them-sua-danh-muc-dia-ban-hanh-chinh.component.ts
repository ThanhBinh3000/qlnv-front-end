...
@Component({
    selector: 'them-sua-danh-muc-dia-ban-hanh-chinh',
    templateUrl: './them-sua-danh-muc-dia-ban-hanh-chinh.component.html',
    styleUrls: ['./them-sua-danh-muc-dia-ban-hanh-chinh.component.scss'],
})
export class ThemSuaDanhMucDiaBanHanhChinh implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucDiaBanHanhChinh>,
