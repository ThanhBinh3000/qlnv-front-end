...
@Component({
    selector: 'them-sua-danh-muc-phuong-xa',
    templateUrl: './them-sua-danh-muc-phuong-xa.component.html',
    styleUrls: ['./them-sua-danh-muc-phuong-xa.component.scss'],
})
export class ThemSuaDanhMucPhuongXa implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucPhuongXa>,
