...
import { ThemSuaDanhMucQuanHuyen } from '../them-sua-danh-muc-quan-huyen/them-sua-danh-muc-quan-huyen.component';

@Component({
    selector: 'danh-sach-danh-muc-quan-huyen',
    templateUrl: './danh-sach-danh-muc-quan-huyen.component.html',
    styleUrls: ['./danh-sach-danh-muc-quan-huyen.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DanhSachDanhMucQuanHuyen implements OnInit, OnDestroy, OnChanges, AfterViewInit {
    @Input()
    userCollection: any;
    ...
    commonFunc(element: any, isView: boolean) {
        const termDialog = this.dialog.open(ThemSuaDanhMucQuanHuyen, {
            width: '450px',
            data: {
        ...
        this.config = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    label: 'Quận huyện',
                    fieldName: 'cap',
                    actionFunction2: this.getPhuongXa.bind(this),
                    templateFunction2: () => {
    ...
    getPhuongXa(event: any, element: any) {
        this.router.navigate([`dmuc-dia-ban-hanh-chinh/dmuc-quan-huyen/${element.maDbhc}/dmuc-phuong-xa/`,element.maDbhc]);
