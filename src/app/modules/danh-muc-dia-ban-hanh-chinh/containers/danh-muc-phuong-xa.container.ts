...
import { DanhSachDanhMucPhuongXa } from '../components';

@Component({
    selector: 'danh-muc-phuong-xa-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-phuong-xa
...
export class DanhMucPhuongXaContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucPhuongXa, { static: true })
    listUserForm: DanhSachDanhMucPhuongXa;
