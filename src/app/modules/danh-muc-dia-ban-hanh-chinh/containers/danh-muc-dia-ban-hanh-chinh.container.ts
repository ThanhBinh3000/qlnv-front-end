...
import { DanhSachDanhMucDiaBanHanhChinh } from '../components';

@Component({
    selector: 'danh-muc-dia-ban-hanh-chinh-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-dia-ban-hanh-chinh
...
export class DanhMucDiaBanHanhChinhContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucDiaBanHanhChinh, { static: true })
    listUserForm: DanhSachDanhMucDiaBanHanhChinh;
    ...
    constructor(private service: DanhMucDiaBanHanhChinhService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
