...
import { DanhSachDanhMucQuanHuyen } from '../components';

@Component({
    selector: 'danh-muc-quan-huyen-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-quan-huyen
...
export class DanhMucQuanHuyenContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucQuanHuyen, { static: true })
    listUserForm: DanhSachDanhMucQuanHuyen;
