...
import { DanhSachDanhMucThuKho } from '../components';
import { DanhMucThuKhoService } from '../services';

@Component({
    selector: 'danh-muc-thu-kho-dashboard',
    template: `
        <div class="grid-container1 main-content">
            <danh-sach-danh-muc-thu-kho
...
export class DanhMucThuKhoContainer implements OnInit, OnDestroy {
    pageSize = 10;

    @ViewChild(DanhSachDanhMucThuKho, { static: true })
    listUserForm: DanhSachDanhMucThuKho;
    ...
    constructor(private service: DanhMucThuKhoService, private dialog: MatDialog, private spinner: NgxSpinnerService) {}
