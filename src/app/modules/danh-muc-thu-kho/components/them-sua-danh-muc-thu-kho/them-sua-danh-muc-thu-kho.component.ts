...
import { ThuKhoModel } from '../..';

@Component({
    selector: 'them-sua-danh-muc-thu-kho',
    templateUrl: './them-sua-danh-muc-thu-kho.component.html',
    styleUrls: ['./them-sua-danh-muc-thu-kho.component.scss'],
})
export class ThemSuaDanhMucThuKho implements OnInit {
    @ViewChild('f', { static: true })
    formDirective: NgForm;

    constructor(
        private fb: FormBuilder,
        private matDialogRef: MatDialogRef<ThemSuaDanhMucThuKho>,
    ...
    ngOnInit(): void {
        ...
        if(this.data.id == null || this.data.id > 0) {
            this.form = this.fb.group({
                maThukho: new FormControl('', {}),
                tenThukho: new FormControl('', {}),
            ...
            this.form = this.fb.group({
                maThukho: new FormControl(this.data.maThukho),
                tenThukho: new FormControl(this.data.tenThukho),
