...
@Component({
  selector: 'dialog-chi-tiet-quyet-dinh-gia-nhap',
  templateUrl: './dialog-chi-tiet-quyet-dinh-gia-nhap.component.html',
  styleUrls: ['./dialog-chi-tiet-quyet-dinh-gia-nhap.component.scss'],
})
export class DialogChiTietQuyetDinhGiaNhapComponent implements OnInit {
  page: number = 1;
