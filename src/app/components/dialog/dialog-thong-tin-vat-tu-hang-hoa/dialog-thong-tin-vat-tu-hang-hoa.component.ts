...
@Component({
  selector: 'dialog-thong-tin-vat-tu-hang-hoa',
  templateUrl: './dialog-thong-tin-vat-tu-hang-hoa.component.html',
  styleUrls: ['./dialog-thong-tin-vat-tu-hang-hoa.component.scss'],
})
export class DialogThongTinVatTuHangHoaComponent implements OnInit {
  formData: FormGroup;
