...
@Component({
    selector: 'dialog-danh-sach-vat-tu-hang-hoa',
    templateUrl: './dialog-danh-sach-vat-tu-hang-hoa.component.html',
    styleUrls: ['./dialog-danh-sach-vat-tu-hang-hoa.component.scss'],
})
export class DialogDanhSachVatTuHangHoaComponent implements OnInit {
    data: any;
