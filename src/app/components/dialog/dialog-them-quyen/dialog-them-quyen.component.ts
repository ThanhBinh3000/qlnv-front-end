...
@Component({
  selector: 'dialog-them-quyen',
  templateUrl: './dialog-them-quyen.component.html',
  styleUrls: ['./dialog-them-quyen.component.scss'],
})
export class DialogThemQuyenComponent implements OnInit {
  dataEdit: any;
  isView: boolean;
  formData: FormGroup;
