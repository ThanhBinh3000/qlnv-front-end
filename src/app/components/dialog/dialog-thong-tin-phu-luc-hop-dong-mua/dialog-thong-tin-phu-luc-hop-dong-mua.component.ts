...
@Component({
  selector: 'dialog-thong-tin-phu-luc-hop-dong-mua',
  templateUrl: './dialog-thong-tin-phu-luc-hop-dong-mua.component.html',
  styleUrls: ['./dialog-thong-tin-phu-luc-hop-dong-mua.component.scss'],
})
export class DialogThongTinPhuLucHopDongMuaComponent implements OnInit {
  cucDTNN: string = null;
  listDonVi: any[] = [];
  tenDuAn: string = null;
  ghiChu: string = null;
