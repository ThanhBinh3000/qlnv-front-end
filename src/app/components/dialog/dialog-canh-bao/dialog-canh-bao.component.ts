...
@Component({
  selector: 'dialog-canh-bao',
  templateUrl: './dialog-canh-bao.component.html',
  styleUrls: ['./dialog-canh-bao.component.scss'],
})
export class DialogCanhBaoComponent implements OnInit {
  formData: FormGroup;
