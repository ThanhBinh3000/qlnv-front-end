...
@Component({
  selector: 'dialog-bao-cao-bien-ban-nghiem-thu-ke-lot',
  templateUrl: './dialog-bao-cao-bien-ban-nghiem-thu-ke-lot.component.html',
  styleUrls: ['./dialog-bao-cao-bien-ban-nghiem-thu-ke-lot.component.scss'],
})
export class DialogBaoCaoBienBanNghiemThuKeLotComponent implements OnInit {
  formData: FormGroup;
