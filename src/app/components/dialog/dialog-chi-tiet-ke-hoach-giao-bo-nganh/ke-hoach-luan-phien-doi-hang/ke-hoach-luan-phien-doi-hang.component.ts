...
@Component({
  selector: 'app-ke-hoach-luan-phien-doi-hang',
  templateUrl: './ke-hoach-luan-phien-doi-hang.component.html',
  styleUrls: ['./ke-hoach-luan-phien-doi-hang.component.scss'],
})
export class KeHoachLuanPhienDoiHangComponent implements OnInit {
  dataTable = [];

  rowItem: ILuanPhienDoiHang = {
    id: null,
    idHangHoa: null,
    tenHangHoa: null,
  ...
  dataEdit: { [key: string]: { edit: boolean; data: ILuanPhienDoiHang } } = {};
  dsHangHoa = [];
  dsChungLoaiHangHoa = [];
  dsDonViTinh = [];
  dsKeHoachNam = [];
