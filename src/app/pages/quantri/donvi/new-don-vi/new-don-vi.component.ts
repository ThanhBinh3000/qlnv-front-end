...
export class NewDonViComponent implements OnInit {
  ...
  @ViewChild('treeSelectTypeDonvi', { static: false })
  treeSelectTypeDonvi!: NzTreeComponent;
  ...
  add() {
    ...
    this.formDonVi.patchValue({
      parentId: this.treeSelect.getSelectedNodeList()[0].key,
    });
