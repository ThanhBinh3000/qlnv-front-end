...
@Component({
  selector: 'app-quyet-dinh-phe-duyet-bao-cao-ktkt-sctx',
  templateUrl: './quyet-dinh-phe-duyet-bao-cao-ktkt-sctx.component.html',
  styleUrls: ['./quyet-dinh-phe-duyet-bao-cao-ktkt-sctx.component.scss']
})
export class QuyetDinhPheDuyetBaoCaoKtktSctxComponent implements OnInit {
  @Input()
  itemDuAn: any;
