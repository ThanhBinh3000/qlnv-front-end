...
@Component({
  ...
  templateUrl: './tien-do-sua-chua-thuong-xuyen.component.html',
  styleUrls: ['./tien-do-sua-chua-thuong-xuyen.component.scss']
})
export class TienDoSuaChuaThuongXuyenComponent extends Base2Component implements OnInit {
  listTrangThai: any[] = [
