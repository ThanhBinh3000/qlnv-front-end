...
import {KhoiLuongCongViec} from "../them-moi-hop-dong-sctx/them-moi-hop-dong-sctx.component";

@Component({
  selector: 'app-phu-luc-hop-dong-sctx',
  templateUrl: './phu-luc-hop-dong-sctx.component.html',
  styleUrls: ['./phu-luc-hop-dong-sctx.component.scss']
})
export class PhuLucHopDongSctxComponent extends Base2Component implements OnInit {
  @Input() id: number
