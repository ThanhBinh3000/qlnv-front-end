...
@Component({
  selector: 'app-thong-tin-hop-dong-sctx',
  templateUrl: './thong-tin-hop-dong-sctx.component.html',
  styleUrls: ['./thong-tin-hop-dong-sctx.component.scss']
})
export class ThongTinHopDongSctxComponent extends Base2Component implements OnInit {
  @Input()
  idInput: number;
  @Output()
