...
@Component({
  selector: 'app-quyet-dinh-phe-duyet-kqlcnt-sctx',
  templateUrl: './quyet-dinh-phe-duyet-kqlcnt-sctx.component.html',
  styleUrls: ['./quyet-dinh-phe-duyet-kqlcnt-sctx.component.scss']
})
export class QuyetDinhPheDuyetKqlcntSctxComponent extends Base2Component implements OnInit {
  selectedId: number = 0;
