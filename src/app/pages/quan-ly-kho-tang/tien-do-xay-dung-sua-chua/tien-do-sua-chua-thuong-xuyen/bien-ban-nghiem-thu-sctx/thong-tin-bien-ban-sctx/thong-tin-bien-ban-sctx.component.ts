...
@Component({
  ...
  templateUrl: './thong-tin-bien-ban-sctx.component.html',
  styleUrls: ['./thong-tin-bien-ban-sctx.component.scss']
})
export class ThongTinBienBanSctxComponent extends Base2Component implements OnInit {
  @Input() id: number;
