...
import {KhoiLuongCongViec} from "../them-moi-hop-dong/them-moi-hop-dong.component";
...
export class PhuLucHopDongComponent extends Base2Component implements OnInit {
  @Input() id: number
