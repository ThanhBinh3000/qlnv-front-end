...
@Component({
  ...
  templateUrl: './thong-tin-bien-ban-scl.component.html',
  styleUrls: ['./thong-tin-bien-ban-scl.component.scss']
})
export class ThongTinBienBanSclComponent extends Base2Component implements OnInit {
  @Input() id: number;
