...
@Component({
  ...
  templateUrl: './them-moi-hop-dong-scl.component.html',
  styleUrls: ['./them-moi-hop-dong-scl.component.scss']
})
export class ThemMoiHopDongSclComponent extends Base2Component implements OnInit {
