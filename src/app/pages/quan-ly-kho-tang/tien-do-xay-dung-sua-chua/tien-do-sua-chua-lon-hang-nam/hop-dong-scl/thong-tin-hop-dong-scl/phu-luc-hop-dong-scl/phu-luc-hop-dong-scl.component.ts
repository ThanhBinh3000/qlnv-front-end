...
@Component({
  ...
  templateUrl: './phu-luc-hop-dong-scl.component.html',
  styleUrls: ['./phu-luc-hop-dong-scl.component.scss']
})
export class PhuLucHopDongSclComponent extends Base2Component implements OnInit {
  @Input() id: number
