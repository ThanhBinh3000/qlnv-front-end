...
import { ROUTE_LIST_KE_HOACH } from './quan-ly-ke-hoach-von-phi.constant';
@Component({
  selector: 'app-quan-ly-ke-hoach-von-phi',
  templateUrl: './quan-ly-ke-hoach-von-phi.component.html',
  styleUrls: ['./quan-ly-ke-hoach-von-phi.component.scss'],
})
export class QuanLyKeHoachVonPhiComponent implements OnInit, AfterViewInit {
