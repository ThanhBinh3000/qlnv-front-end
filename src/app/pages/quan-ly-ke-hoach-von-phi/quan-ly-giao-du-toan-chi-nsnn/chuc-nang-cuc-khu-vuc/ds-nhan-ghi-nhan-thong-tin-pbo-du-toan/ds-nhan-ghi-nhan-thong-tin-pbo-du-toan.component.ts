...
@Component({
  selector: 'app-ds-nhan-ghi-nhan-thong-tin-pbo-du-toan',
  templateUrl: './ds-nhan-ghi-nhan-thong-tin-pbo-du-toan.component.html',
  styleUrls: ['./ds-nhan-ghi-nhan-thong-tin-pbo-du-toan.component.scss']
})

export class DsNhanGhiNhanThongTinPboDuAnComponent implements OnInit {
