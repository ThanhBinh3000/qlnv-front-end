...
@Component({
  selector: 'app-danh-sach-ke-hoach-phan-bo-ngan-sach',
  templateUrl: './danh-sach-ke-hoach-phan-bo-ngan-sach.component.html',
  styleUrls: ['./danh-sach-ke-hoach-phan-bo-ngan-sach.component.scss']
})

export class DanhSachKeHoachPhanBoNganSachComponent implements OnInit {
