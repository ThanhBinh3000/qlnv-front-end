...
@Component({
     selector: 'app-nhap-tt-tien-von-mua-hang-von-ung',
     templateUrl: './nhap-tt-tien-von-mua-hang-von-ung.component.html',
     styleUrls: ['./nhap-tt-tien-von-mua-hang-von-ung.component.scss'],
})

export class NhapTtTienVonMuaHangVonUngComponent implements OnInit {
     donVis: any = [];
     vatTus: any = [];
     loaiVons: any = [];
     dviTinhs: any = [];
