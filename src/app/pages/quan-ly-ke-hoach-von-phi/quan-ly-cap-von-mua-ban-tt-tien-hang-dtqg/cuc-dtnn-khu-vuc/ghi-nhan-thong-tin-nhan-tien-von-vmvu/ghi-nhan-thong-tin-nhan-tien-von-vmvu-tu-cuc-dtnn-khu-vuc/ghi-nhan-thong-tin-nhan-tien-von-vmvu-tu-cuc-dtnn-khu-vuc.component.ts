...
@Component({
     selector: 'app-ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-cuc-dtnn-khu-vuc',
     templateUrl: './ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-cuc-dtnn-khu-vuc.component.html',
     styleUrls: ['./ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-cuc-dtnn-khu-vuc.component.scss'],
})

export class GhiNhanThongTinNhanTienVonVmvuTuCucDtnnKhuVucComponent implements OnInit {
     donVis: any = [];
     vatTus: any = [];
     nguonVons: any = [];
     chungLoais: any = [];
