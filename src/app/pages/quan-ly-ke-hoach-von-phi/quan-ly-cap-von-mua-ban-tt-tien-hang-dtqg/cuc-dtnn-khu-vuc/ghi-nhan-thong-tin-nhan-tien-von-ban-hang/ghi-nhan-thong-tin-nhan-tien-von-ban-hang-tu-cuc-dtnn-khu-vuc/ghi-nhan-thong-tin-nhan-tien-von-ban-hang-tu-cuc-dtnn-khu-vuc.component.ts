...
@Component({
     selector: 'app-ghi-nhan-thong-tin-nhan-tien-von-ban-hang-tu-cuc-dtnn-khu-vuc',
     templateUrl: './ghi-nhan-thong-tin-nhan-tien-von-ban-hang-tu-cuc-dtnn-khu-vuc.component.html',
     styleUrls: ['./ghi-nhan-thong-tin-nhan-tien-von-ban-hang-tu-cuc-dtnn-khu-vuc.component.scss'],
})

export class GhiNhanThongTinNhanTienVonBanHangTuCucDtnnKhuVucComponent implements OnInit {
     donVis: any = [];
     cucKhuVucs: any = [];
     vatTus: any = [];
     nguonVons: any = [];
