...
@Component({
     selector: 'app-nhap-thong-tin-cap-tien-von-mua-hang-von-ung',
     templateUrl: './nhap-thong-tin-cap-tien-von-mua-hang-von-ung.component.html',
     styleUrls: ['./nhap-thong-tin-cap-tien-von-mua-hang-von-ung.component.scss'],
})

export class NhapThongTinCapTienVonMuaHangVonUngComponent implements OnInit {
     donVis: any = [];
     cucKhuVucs: any = [];
     vatTus: any = [];
     nguonVons: any = [];
