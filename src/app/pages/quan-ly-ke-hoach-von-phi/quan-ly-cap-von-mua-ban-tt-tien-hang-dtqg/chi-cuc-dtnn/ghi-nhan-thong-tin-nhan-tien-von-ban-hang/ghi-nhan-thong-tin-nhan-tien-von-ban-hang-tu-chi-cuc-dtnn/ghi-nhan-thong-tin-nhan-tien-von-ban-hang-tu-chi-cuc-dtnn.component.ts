...
@Component({
     selector: 'app-ghi-nhan-thong-tin-nhan-tien-von-ban-hang-tu-chi-cuc-dtnn',
     templateUrl: './ghi-nhan-thong-tin-nhan-tien-von-ban-hang-tu-chi-cuc-dtnn.component.html',
     styleUrls: ['./ghi-nhan-thong-tin-nhan-tien-von-ban-hang-tu-chi-cuc-dtnn.component.scss'],
})

export class GhiNhanThongTinNhanTienVonBanHangTuChiCucDtnnComponent implements OnInit {
     donVis: any = [];
     cucKhuVucs: any = [];
     vatTus: any = [];
     nguonVons: any = [];
     ...
     async uploadFile(file: File) {
          ...
          upfile.append('folder', this.ccQd + '/' + this.dviLap + '/');
