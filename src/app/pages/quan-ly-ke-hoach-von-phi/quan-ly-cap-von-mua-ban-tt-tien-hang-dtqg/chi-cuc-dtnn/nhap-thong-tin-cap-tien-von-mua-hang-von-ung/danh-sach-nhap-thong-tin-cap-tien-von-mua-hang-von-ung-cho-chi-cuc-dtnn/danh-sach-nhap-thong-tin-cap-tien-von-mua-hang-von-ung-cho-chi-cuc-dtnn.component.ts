...
@Component({
     selector: 'app-danh-sach-nhap-thong-tin-cap-tien-von-mua-hang-von-ung-cho-chi-cuc-dtnn',
     templateUrl: './danh-sach-nhap-thong-tin-cap-tien-von-mua-hang-von-ung-cho-chi-cuc-dtnn.component.html',
     styleUrls: ['./danh-sach-nhap-thong-tin-cap-tien-von-mua-hang-von-ung-cho-chi-cuc-dtnn.component.scss'],
})

export class DanhSachNhapThongTinCapTienVonMuaHangVonUngChoChiCucDtnnComponent implements OnInit {
     donVis: any = [];
     trangThais: any = [
          {
               id: 1,
