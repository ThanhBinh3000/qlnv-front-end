...
@Component({
     selector: 'app-nhap-thong-tin-cap-tien-von-mua-hang-von-ung-cho-chi-cuc-dtnn',
     templateUrl: './nhap-thong-tin-cap-tien-von-mua-hang-von-ung-cho-chi-cuc-dtnn.component.html',
     styleUrls: ['./nhap-thong-tin-cap-tien-von-mua-hang-von-ung-cho-chi-cuc-dtnn.component.scss'],
})

export class NhapThongTinCapTienVonMuaHangVonUngChoChiCucDtnnComponent implements OnInit {
     donVis: any = [];
     vatTus: any = [];
     nguonVons: any = [];
     chungLoais: any = [];
