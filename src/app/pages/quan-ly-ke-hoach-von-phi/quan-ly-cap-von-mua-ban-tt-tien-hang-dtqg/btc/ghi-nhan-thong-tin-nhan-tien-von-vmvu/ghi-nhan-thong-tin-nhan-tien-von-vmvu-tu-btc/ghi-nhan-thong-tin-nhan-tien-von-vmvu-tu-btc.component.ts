...
@Component({
     selector: 'app-ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-btc',
     templateUrl: './ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-btc.component.html',
     styleUrls: ['./ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-btc.component.scss'],
})

export class GhiNhanThongTinNhanTienVonVmvuTuBtcComponent implements OnInit {
     donVis: any = [];
     vatTus: any = [];
     nguonVons: any = [];
     chungLoais: any = [];
