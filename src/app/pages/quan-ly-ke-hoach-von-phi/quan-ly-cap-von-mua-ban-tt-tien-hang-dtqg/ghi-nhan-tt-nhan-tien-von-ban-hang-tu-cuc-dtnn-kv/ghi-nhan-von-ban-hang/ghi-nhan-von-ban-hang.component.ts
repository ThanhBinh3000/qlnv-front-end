...
@Component({
     selector: 'app-ghi-nhan-von-ban-hang',
     templateUrl: './ghi-nhan-von-ban-hang.component.html',
     styleUrls: ['./ghi-nhan-von-ban-hang.component.scss'],
})

export class GhiNhanVonBanHangComponent implements OnInit {
     donVis: any = [];
     vatTus: any = [];
     loaiVons: any = [];
     dviTinhs: any = [];
