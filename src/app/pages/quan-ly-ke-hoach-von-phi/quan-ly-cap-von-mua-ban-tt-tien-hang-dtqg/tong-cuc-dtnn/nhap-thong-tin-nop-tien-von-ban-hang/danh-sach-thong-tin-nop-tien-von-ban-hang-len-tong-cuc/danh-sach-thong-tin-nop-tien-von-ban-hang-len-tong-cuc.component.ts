...
@Component({
     selector: 'app-danh-sach-thong-tin-nop-tien-von-ban-hang-len-tong-cuc',
     templateUrl: './danh-sach-thong-tin-nop-tien-von-ban-hang-len-tong-cuc.component.html',
     styleUrls: ['./danh-sach-thong-tin-nop-tien-von-ban-hang-len-tong-cuc.component.scss'],
})

export class DanhSachThongTinNopTienVonBanHangLenTongCucComponent implements OnInit {
     tuNgayCap!: string;
     denNgayCap!: string;
     tuNgayQd!: string;
     denNgayQd!: string;
