...
@Component({
     selector: 'app-nhap-thong-tin-nop-tien-von-ban-hang-len-tong-cuc',
     templateUrl: './nhap-thong-tin-nop-tien-von-ban-hang-len-tong-cuc.component.html',
     styleUrls: ['./nhap-thong-tin-nop-tien-von-ban-hang-len-tong-cuc.component.scss'],
})

export class NhapThongTinNopTienVonBanHangLenTongCucComponent implements OnInit {
     donVis: any = [];
     cucKhuVucs: any = [];
     vatTus: any = [];
     nguonVons: any = [];
     ...
     async uploadFile(file: File) {
          ...
          upfile.append('folder', this.ccQd + '/' + this.noiLap + '/');
