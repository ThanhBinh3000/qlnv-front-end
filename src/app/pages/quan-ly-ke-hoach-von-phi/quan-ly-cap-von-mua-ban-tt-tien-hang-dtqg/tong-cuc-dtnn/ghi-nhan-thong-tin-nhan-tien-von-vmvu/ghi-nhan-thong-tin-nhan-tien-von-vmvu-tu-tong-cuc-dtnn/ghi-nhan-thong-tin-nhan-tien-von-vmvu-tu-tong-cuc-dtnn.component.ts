...
@Component({
     selector: 'app-ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-tong-cuc-dtnn',
     templateUrl: './ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-tong-cuc-dtnn.component.html',
     styleUrls: ['./ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-tong-cuc-dtnn.component.scss'],
})

export class GhiNhanThongTinNhanTienVonVmvuTuTongCucDtnnComponent implements OnInit {
     donVis: any = [];
     vatTus: any = [];
     nguonVons: any = [];
     chungLoais: any = [];
     ...
     saveEdit(id: string): void {
          ...
          this.lstCTietBCao[index].ngayGhiNhan = this.datePipe.transform(this.lstCTietBCao[index].ngayGhiNhan, Utils.FORMAT_DATE_STR,);
     ...
     changeModel(id: string): void {
          this.editCache[id].data.thanhTien = this.editCache[id].data.sl * this.editCache[id].data.soTien;
     }
