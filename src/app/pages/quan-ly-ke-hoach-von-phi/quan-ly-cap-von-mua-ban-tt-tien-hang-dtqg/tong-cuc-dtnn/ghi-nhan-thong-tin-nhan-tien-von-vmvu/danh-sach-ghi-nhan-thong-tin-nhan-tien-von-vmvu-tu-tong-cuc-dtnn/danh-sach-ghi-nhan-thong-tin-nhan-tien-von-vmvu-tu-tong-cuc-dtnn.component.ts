...
@Component({
     selector: 'app-danh-sach-ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-tong-cuc-dtnn',
     templateUrl: './danh-sach-ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-tong-cuc-dtnn.component.html',
     styleUrls: ['./danh-sach-ghi-nhan-thong-tin-nhan-tien-von-vmvu-tu-tong-cuc-dtnn.component.scss'],
})

export class DanhSachGhiNhanThongTinNhanTienVonVmvuTaiTongCucDtnnComponent implements OnInit {
     ngayCapTu!: string;
     denNgayCap!: string;
     ngayGhiNhanTu!: string;
     denNgayGn!: string;
     soQd!: string;
