...
@Component({
     selector: 'app-danh-sach-thanh-toan-tien-von-mua-hang-cho-khach-hang-tai-tong-cuc',
     templateUrl: './danh-sach-thanh-toan-tien-von-mua-hang-cho-khach-hang-tai-tong-cuc.component.html',
     styleUrls: ['./danh-sach-thanh-toan-tien-von-mua-hang-cho-khach-hang-tai-tong-cuc.component.scss'],
})

export class DanhSachThanhToanTienVonMuaHangChoKhachHangTaiTongCucComponent implements OnInit {
     tuNgayLap!: string;
     denNgayLap!: string;
     tuNgayPd!: string;
     denNgayPd!: string;
