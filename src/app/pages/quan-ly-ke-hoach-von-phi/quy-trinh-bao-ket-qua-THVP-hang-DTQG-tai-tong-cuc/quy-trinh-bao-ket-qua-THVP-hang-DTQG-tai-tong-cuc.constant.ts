...
export const QUY_TRINH_BAO_CAO_KET_QUA_THUC_HIEN_THVP_HANG_DTQG_TAI_TONG_CUC_DTNN_LIST: QuytrinhbaocaoketquaTHVPhangDTQGtaitongtuc[] = [
  {
    ...
    title: 'Tìm kiếm báo cáo thực hiện vốn, phí hàng DTQG',
    description: 'Tìm kiếm báo cáo thực hiện vốn, phí hàng DTQG',
    url: `/${MAIN_ROUTE_QUAN_LY_KE_HOACH_VON_PHI}/${MAIN_ROUTE_QUY_BAO_CAO_KET_QUA_THUC_HIEN_VON_PHI_HANG_DTQG_TAI_TONG_CUC_DTNN}/tim-kiem-bao-cao-thuc-hien-von-phi-hang-dtqg`,
  },
