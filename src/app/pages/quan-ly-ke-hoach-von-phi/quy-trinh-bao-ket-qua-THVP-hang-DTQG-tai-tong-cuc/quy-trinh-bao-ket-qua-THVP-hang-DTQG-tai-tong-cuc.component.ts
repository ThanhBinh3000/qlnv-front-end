...
import { QUY_TRINH_BAO_CAO_KET_QUA_THUC_HIEN_THVP_HANG_DTQG_TAI_TONG_CUC_DTNN_LIST } from './quy-trinh-bao-ket-qua-THVP-hang-DTQG-tai-tong-cuc.constant';
interface DataItem {
  name: string;
  age: number;
  street: string;
...
export class QuytrinhbaocaoketquaTHVPhangDTQGtaitongtucComponent implements OnInit {
  ...
  noParent = true;
  searchValue = '';
  QuytrinhbaocaoketquaTHVPhangDTQGtaitongtucList = QUY_TRINH_BAO_CAO_KET_QUA_THUC_HIEN_THVP_HANG_DTQG_TAI_TONG_CUC_DTNN_LIST;
  searchFilter = {
    soDeXuat: '',
  };
  ////////
