...
export class ItemData {
  ...
  ssanhNcauNVoiN1: number = this.ncauChiN1/this.tranChiN1;
  tranChiN2!: number;
  ncauChiN2!: number;
...
@Component({
  selector: 'app-tonghopnhucauchingansachnhanuocgiadoan3nam',
  templateUrl: './tonghopnhucauchingansachnhanuocgiadoan3nam.component.html',
  styleUrls: ['./tonghopnhucauchingansachnhanuocgiadoan3nam.component.scss']
})
export class Tonghopnhucauchingansachnhanuocgiadoan3namComponent implements OnInit {
  ...
  id: any;
  maDvi: any;
  maLoaiBacao: string = QLNV_KHVONPHI_TC_THOP_NCAU_CHI_NSNN_GD3N;
  nam: any;
  userInfor: any;
...
//check role cho các nut trinh duyet
  ...
  async luu() {
    ...
    this.lstCTietBCao.filter(item => {
       let  dtoanN = mulMoney(item.dtoanN, this.donvitien);
       let  uocThienN = mulMoney(item.uocThienN, this.donvitien);
       ...
       let  ssanhNcauNVoiN1 = mulMoney(item.ssanhNcauNVoiN1, this.donvitien);
      ...
      lstCTietBCaoTemp.push({
        ...
        ssanhNcauNVoiN1 : ssanhNcauNVoiN1,
        tranChiN2 : tranChiN2,
        ncauChiN2 : ncauChiN2,
