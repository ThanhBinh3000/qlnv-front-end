...
export class DanhSachBaoCaoQuyetToanVonPhiHangDTQGComponent implements OnInit {
  ...
  taoMoi() {
    this.router.navigate([
      '/qlkh-von-phi/quan-ly-thong-tin-quyet-toan-von-phi-hang-dtqg/them-moi-bao-cao-quyet-toan-/' + this.searchFilter.namQtoan,
    ])
  }

  xemChiTiet(id: string) {
    this.router.navigate([
      '/qlkh-von-phi/quan-ly-thong-tin-quyet-toan-von-phi-hang-dtqg/them-moi-bao-cao-quyet-toan/' + id,
    ])
  }
