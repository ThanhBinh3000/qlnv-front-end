import { MAIN_ROUTE_QUAN_LY_KE_HOACH_VON_PHI, MAIN_ROUTE_QUAN_LY_THONG_TIN_QUYET_TOAN_VON_PHI_HANG_DTQG } from './../../../../constants/routerUrl';
import { QuanLyThongTinQuyetToan } from './quan-ly-thong-tin-quyet-toan.type';
// import {MAIN_ROUTE_QUAN_LY_THONG_TIN_QUYET_TOAN} from '../../../../constants/routerUrl';
...
export const QUAN_LY_THONG_TIN_QUYET_TOAN_LIST: QuanLyThongTinQuyetToan[] = [
  {
    ...
    url: `/${MAIN_ROUTE_QUAN_LY_KE_HOACH_VON_PHI}/${MAIN_ROUTE_QUAN_LY_THONG_TIN_QUYET_TOAN_VON_PHI_HANG_DTQG}/danh-sach-bao-cao-quyet-toan-von-phi-hang-DTQG`,
    unRole: [],
		isDisabled: false,
  },
  {
    ...
    url: `/${MAIN_ROUTE_QUAN_LY_KE_HOACH_VON_PHI}/${MAIN_ROUTE_QUAN_LY_THONG_TIN_QUYET_TOAN_VON_PHI_HANG_DTQG}/danh-sach-bao-cao-dieu-chinh-quyet-toan-von-phi-hang-DTQG`,
    unRole: [
      {
				"unit": TONG_CUC,
				"role": 'TC_KH_VP_LD',
  ...
  },
  {
    ...
    url: `/${MAIN_ROUTE_QUAN_LY_KE_HOACH_VON_PHI}/${MAIN_ROUTE_QUAN_LY_THONG_TIN_QUYET_TOAN_VON_PHI_HANG_DTQG}/duyet-phe-duyet-bao-cao`,
    unRole: [
      {
				"unit": TONG_CUC,
				"role": 'TC_KH_VP_NV',
