...
export class DanhSachBaoCaoDieuChinhQuyetToanVonPhiHangDTQGComponent implements OnInit {
  ...
  taoMoi() {
    this.router.navigate([
      '/qlkh-von-phi/quan-ly-thong-tin-quyet-toan-von-phi-hang-dtqg/dieu-chinh-so-lieu-quyet-toan-/' + this.searchFilter.namQtoan ,
    ])
  }

  xemChiTiet(id: string) {
    this.router.navigate([
      '/qlkh-von-phi/quan-ly-thong-tin-quyet-toan-von-phi-hang-dtqg/dieu-chinh-so-lieu-quyet-toan/' + id,
    ])
  }
