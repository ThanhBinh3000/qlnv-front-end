...
@Component({
     selector: 'app-dsach-thop-bcao-dcdt-chi-nsnn-trinh-tong-cuc',
     templateUrl: './dsach-thop-bcao-dcdt-chi-nsnn-trinh-tong-cuc.component.html',
     styleUrls: ['./dsach-thop-bcao-dcdt-chi-nsnn-trinh-tong-cuc.component.scss'],
})

export class DsachThopBcaoDcdtChiNsnnTrinhTongCucComponent implements OnInit {
     donVis: any = [];
     cucKhuVucs: any = [];
     maDvi!: string;
