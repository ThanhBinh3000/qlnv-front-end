...
@Component({
  selector: 'ds-hop-dong-mua-tc',
  templateUrl: './ds-hop-dong-mua-tc.component.html',
  styleUrls: ['./ds-hop-dong-mua-tc.component.scss'],
})
export class DsHopDongMuaTCComponent implements OnInit {
  searchValue = '';
  searchFilter = {
    soQD: '',
    donViId: '',
