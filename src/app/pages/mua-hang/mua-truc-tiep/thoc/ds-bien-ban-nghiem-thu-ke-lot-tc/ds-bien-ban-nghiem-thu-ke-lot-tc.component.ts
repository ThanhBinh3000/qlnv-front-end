...
import { DialogBaoCaoBienBanNghiemThuKeLotComponent } from 'src/app/components/dialog/dialog-bao-cao-bien-ban-nghiem-thu-ke-lot/dialog-bao-cao-bien-ban-nghiem-thu-ke-lot.component';
@Component({
  selector: 'ds-bien-ban-nghiem-thu-ke-lot-tc',
  templateUrl: './ds-bien-ban-nghiem-thu-ke-lot-tc.component.html',
  styleUrls: ['./ds-bien-ban-nghiem-thu-ke-lot-tc.component.scss'],
})
export class DsBienBanNghiemThuKeLotTCComponent implements OnInit {
  searchValue = '';
  searchFilter = {
    soQD: '',
    donViId: '',
  ...
  print() {
    const modalLuongThuc = this.modal.create({
      nzTitle:
        'Báo cáo biên bản nghiệm thu kê lót, bảo quản ban đầu nhập hàng lương thực DTQG',
      nzContent: DialogBaoCaoBienBanNghiemThuKeLotComponent,
