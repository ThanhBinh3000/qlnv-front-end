...
@Component({
  selector: 'quyet-dinh-gia-nhap-tc',
  templateUrl: './quyet-dinh-gia-nhap-tc.component.html',
  styleUrls: ['./quyet-dinh-gia-nhap-tc.component.scss'],
})
export class QuyetDinhGiaNhapTCComponent implements OnInit {
  searchValue = '';
  searchFilter = {
    soQD: '',
    donViId: '',
