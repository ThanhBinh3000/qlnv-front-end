...
import { TongHopNhuCauChiDauTuPhatTrien3NamComponent } from '../tong-hop-nhu-cau-chi-dau-tu-phat-trien-3-nam/tong-hop-nhu-cau-chi-dau-tu-phat-trien-3-nam.component';
...
@NgModule({
  declarations: [
    BaoCaoComponent,
    TongHopNhuCauChiDauTuPhatTrien3NamComponent,
