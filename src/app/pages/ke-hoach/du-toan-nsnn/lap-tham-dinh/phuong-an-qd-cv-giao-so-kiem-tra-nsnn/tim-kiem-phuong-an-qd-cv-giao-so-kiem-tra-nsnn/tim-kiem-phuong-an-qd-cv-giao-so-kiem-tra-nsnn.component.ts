...
export class TimKiemPhuongAnQdCvGiaoSoKiemTraNsnnComponent implements OnInit {
    ...
    async taoMoi() {
        ...
        if (this.loai == "0") {
            ...
            this.router.navigate([
                MAIN_ROUTE_KE_HOACH + '/' + MAIN_ROUTE_DU_TOAN + '/' + LAP_THAM_DINH + '/so-kiem-tra-tran-chi-tu-btc',
            ]);
        } else {
            this.router.navigate([
                MAIN_ROUTE_KE_HOACH + '/' + MAIN_ROUTE_DU_TOAN + '/' + LAP_THAM_DINH + '/qd-cv-giao-so-kiem-tra-tran-chi-nsnn',
            ]);
        }
    }
    ...
    xemChiTiet(id: string) {
        if (this.loai == "0") {
            this.router.navigate([
                MAIN_ROUTE_KE_HOACH + '/' + MAIN_ROUTE_DU_TOAN + '/' + LAP_THAM_DINH + '/so-kiem-tra-tran-chi-tu-btc/' + id,
            ])
        } else {
            this.router.navigate([
                MAIN_ROUTE_KE_HOACH + '/' + MAIN_ROUTE_DU_TOAN + '/' + LAP_THAM_DINH + '/xay-dung-phuong-an-giao-so-kiem-tra-chi-nsnn/' + id,
            ])
        }
    }
