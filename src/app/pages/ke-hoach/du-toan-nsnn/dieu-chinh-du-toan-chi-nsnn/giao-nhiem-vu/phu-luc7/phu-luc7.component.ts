...
export class PhuLuc7Component implements OnInit {
  ...
  initItem: ItemData = {
    ...
    chenhLech: null,
    soQtoan: null,
    soQtoanChuyenNsauKpTk: null,
    soQtoanChuyenNsauKpTchi: null,
  ...
  async save(trangThai: string) {
    ...
    this.lstCtietBcao.forEach(item => {
      if (
        item.kphiBqDmuc > MONEY_LIMIT ||
        item.kphiBqTtien > MONEY_LIMIT ||
        item.cphiBqTcong > MONEY_LIMIT ||
        item.cphiBqNtruoc > MONEY_LIMIT ||
        item.cphiBqNnay > MONEY_LIMIT ||
        item.chenhLech > MONEY_LIMIT ||
        item.soQtoan > MONEY_LIMIT ||
        item.soQtoanChuyenNsauKpTk > MONEY_LIMIT ||
        item.soQtoanChuyenNsauKpTchi > MONEY_LIMIT ||
  ...
  getTotal() {
    ...
    if (
      ...
      this.total.slHangTte = null,
        this.total.kphiBqDmuc = null,
        this.total.kphiBqTtien = null,
        this.total.cphiBqTcong = null,
        this.total.cphiBqNtruoc = null,
        this.total.cphiBqNnay = null,
        this.total.chenhLech = null,
        this.total.soQtoan = null,
        this.total.soQtoanChuyenNsauKpTk = null,
        this.total.soQtoanChuyenNsauKpTchi = null,
