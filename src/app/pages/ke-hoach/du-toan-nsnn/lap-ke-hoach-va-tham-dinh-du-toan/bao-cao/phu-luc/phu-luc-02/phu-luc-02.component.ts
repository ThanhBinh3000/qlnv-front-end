...
export class ItemData {
	...
	sum(data: ItemData) {
		Object.keys(data).forEach(key => {
			if (!['level', 'sluongTaiKho', 'dmucTaiKho', 'binhQuanNgoaiKho', 'tdinhKhoSluong'].includes(key) && (typeof this[key] == 'number' || typeof data[key] == 'number')) {
...
export class PhuLuc02Component implements OnInit {
	...
	exportToExcel() {
		...
		if (this.status.viewAppVal) {
			...
			calHeader = ['A', 'B', 'C', '1', '2', '3', '4', '5', '6=4*5', '7', '8=4*7', '9=6+8', '10', '11=5*7', '12=11+8', '13=12-9', '14', '15'];
		} else {
			header = [
      ...
      calHeader = ['A', 'B', 'C', '1', '2', '3', '4', '5', '6=4*5', '7', '8=4*7', '9=6+8', '14'];
		}
		...
		fieldOrder.forEach(field => {
			if (field == 'tenDanhMuc') {
				...
				if (!['sluongTaiKho', 'dmucTaiKho', 'binhQuanNgoaiKho', 'tdinhKhoSluong'].includes(field)) {
