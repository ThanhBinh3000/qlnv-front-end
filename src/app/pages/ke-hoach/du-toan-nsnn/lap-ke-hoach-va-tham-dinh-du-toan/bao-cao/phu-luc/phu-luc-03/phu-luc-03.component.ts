...
export class PhuLuc03Component implements OnInit {
	...
	async initialization() {
		...
		if (this.status) {
			this.scrollX = (560 + BOX_NUMBER_WIDTH * 7).toString() + 'px';
		} else {
			if (this.checkEditTD) {
				this.scrollX = (460 + BOX_NUMBER_WIDTH * 9).toString() + 'px';
			} else if (this.checkViewTD) {
				this.scrollX = (400 + BOX_NUMBER_WIDTH * 9).toString() + 'px';
			} else {
				this.scrollX = (400 + BOX_NUMBER_WIDTH * 7).toString() + 'px';
			}
		}
