            ...
            if (res) {
                ...
                if (index == -1) {
                    const data: any = {
                        ...
                        level: this.lstVatTuFull.find(e => e.id == res.maKhoanMuc)?.level,
                        dvTinh: this.lstVatTuFull.find(e => e.id == res.maKhoanMuc)?.dvTinh,
                        tenMatHang: this.lstVatTuFull.find(e => e.id == res.maKhoanMuc)?.tenDm
                    };
