...
export class BieuMau131Component implements OnInit {
    ...
    async initialization() {
        ...
        if (this.status.general) {
            ...
            this.scrollX = this.genFunc.setTableWidth(450, 5, BOX_NUMBER_WIDTH, 60);
        } else {
            if (this.status.editAppVal) {
                this.scrollX = this.genFunc.setTableWidth(450, 6, BOX_NUMBER_WIDTH, 60);
            } else if (this.status.viewAppVal) {
                this.scrollX = this.genFunc.setTableWidth(450, 6, BOX_NUMBER_WIDTH, 0);
            } else {
                this.scrollX = this.genFunc.setTableWidth(450, 5, BOX_NUMBER_WIDTH, 0);
            }
        }
