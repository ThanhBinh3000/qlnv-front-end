...
export class BieuMau140Component implements OnInit {
	...
	async initialization() {
		...
		if (this.status) {
			...
			this.scrollX = (610 + BOX_NUMBER_WIDTH * 4).toString() + 'px';
		} else {
			if (this.editAppraisalValue) {
				this.scrollX = (560 + BOX_NUMBER_WIDTH * 5).toString() + 'px';
			} else if (this.viewAppraisalValue) {
				this.scrollX = (500 + BOX_NUMBER_WIDTH * 5).toString() + 'px';
			} else {
				this.scrollX = (500 + BOX_NUMBER_WIDTH * 4).toString() + 'px';
			}
		}
