...
export const TAB_LIST = [
    {
        ...
        code: 'danhsach',
        status: true,
        role: [Roles.LTD.VIEW_REPORT, Roles.LTD.VIEW_SYNTHETIC_REPORT],
        isSelected: false,
    },
    {
        ...
        code: 'capduoi',
        status: true,
        role: [Roles.LTD.TIEP_NHAN_REPORT],
        isSelected: false,
    },
    {
        ...
        code: 'tonghop',
        status: true,
        role: [Roles.LTD.SYNTHETIC_REPORT],
        isSelected: false,
    },
    {
        name: 'Hệ số bảo hiểm',
        code: 'ds-heso',
        status: true,
        role: [Roles.LTD.VIEW_COEFFCIENT_INSURANCE],
        isSelected: false,
    },
    // {
