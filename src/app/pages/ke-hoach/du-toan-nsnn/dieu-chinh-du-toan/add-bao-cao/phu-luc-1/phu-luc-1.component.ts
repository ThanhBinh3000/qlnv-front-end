...
export class PhuLuc1Component implements OnInit {
    ...
    exportToExcel() {
        const header = [
            ...
            { t: 0, b: 0, l: 2, r: 4, val: 'Dự toán, kinh phí được sử dụng trong năm' },
            { t: 0, b: 1, l: 5, r: 5, val: 'Tổng nhu cầu dự toán trong năm' },
            { t: 0, b: 1, l: 6, r: 6, val: 'Dự toán đề nghị điều chỉnh (+ tăng) (- giảm)' },
            { t: 0, b: 1, l: 7, r: 7, val: 'Ý kiến của đơn vị cấp trên' },
            { t: 0, b: 1, l: 8, r: 8, val: 'Ghi chú' },
            { t: 1, b: 1, l: 2, r: 2, val: 'Dự toán năm trước chuyển sang <br> được cho phép sử dụng cho năm nay' },
            { t: 1, b: 1, l: 3, r: 3, val: 'Dự toán, kinh phí đã giao trong năm' },
            { t: 1, b: 1, l: 4, r: 4, val: 'Cộng' },
            { t: 2, b: 2, l: 0, r: 0, val: 'A' },
            { t: 2, b: 2, l: 1, r: 1, val: 'B' },
            { t: 2, b: 2, l: 2, r: 2, val: '1' },
            { t: 2, b: 2, l: 3, r: 3, val: '2' },
            { t: 2, b: 2, l: 4, r: 4, val: '3 = 2 + 1' },
            { t: 2, b: 2, l: 5, r: 5, val: '4' },
            { t: 2, b: 2, l: 6, r: 6, val: '5 = 4 -3' },
            { t: 2, b: 2, l: 7, r: 7, val: '6' },
            { t: 2, b: 2, l: 8, r: 8, val: '7 = 6 -5' },
            { t: 2, b: 2, l: 9, r: 9, val: '8' },
            { t: 2, b: 2, l: 10, r: 10, val: '9' },
