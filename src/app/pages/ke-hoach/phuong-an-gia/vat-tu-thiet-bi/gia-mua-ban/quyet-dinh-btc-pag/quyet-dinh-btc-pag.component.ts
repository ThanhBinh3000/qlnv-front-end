...
@Component({
  selector: 'app-quyet-dinh-btc-pag',
  templateUrl: './quyet-dinh-btc-pag.component.html',
  styleUrls: ['./quyet-dinh-btc-pag.component.scss']
})
export class QuyetDinhBtcPagComponent implements OnInit {
