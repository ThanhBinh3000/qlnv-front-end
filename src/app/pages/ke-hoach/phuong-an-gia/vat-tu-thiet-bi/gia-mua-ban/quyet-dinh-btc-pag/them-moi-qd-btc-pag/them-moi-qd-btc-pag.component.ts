...
@Component({
  selector: 'app-them-moi-qd-btc-pag',
  templateUrl: './them-moi-qd-btc-pag.component.html',
  styleUrls: ['./them-moi-qd-btc-pag.component.scss']
})
export class ThemMoiQdBtcPagComponent implements OnInit {
