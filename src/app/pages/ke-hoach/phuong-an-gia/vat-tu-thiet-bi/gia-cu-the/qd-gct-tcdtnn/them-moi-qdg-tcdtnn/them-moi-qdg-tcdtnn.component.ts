...
@Component({
  selector: 'app-them-moi-qdg-tcdtnn',
  templateUrl: './them-moi-qdg-tcdtnn.component.html',
  styleUrls: ['./them-moi-qdg-tcdtnn.component.scss']
})
export class ThemMoiQdgTcdtnnComponent implements OnInit {
