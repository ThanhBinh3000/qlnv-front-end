...
@Component({
  selector: 'app-qd-gct-tcdtnn',
  templateUrl: './qd-gct-tcdtnn.component.html',
  styleUrls: ['./qd-gct-tcdtnn.component.scss']
})
export class QdGctTcdtnnComponent implements OnInit {
  @Output()
