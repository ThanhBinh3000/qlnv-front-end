...
@Component({
  selector: 'app-qd-dc-tcdtnn',
  templateUrl: './qd-dc-tcdtnn.component.html',
  styleUrls: ['./qd-dc-tcdtnn.component.scss']
})
export class QdDcTcdtnnComponent implements OnInit {
  @Output()
