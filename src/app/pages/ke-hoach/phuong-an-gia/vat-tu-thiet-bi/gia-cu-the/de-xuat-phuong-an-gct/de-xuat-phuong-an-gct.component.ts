...
@Component({
  selector: 'app-de-xuat-phuong-an-gct',
  templateUrl: './de-xuat-phuong-an-gct.component.html',
  styleUrls: ['./de-xuat-phuong-an-gct.component.scss']
})
export class DeXuatPhuongAnGctComponent implements OnInit {
  @Output()
