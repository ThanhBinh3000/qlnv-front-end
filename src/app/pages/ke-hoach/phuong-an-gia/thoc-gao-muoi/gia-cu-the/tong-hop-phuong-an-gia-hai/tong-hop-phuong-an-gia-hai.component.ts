...
@Component({
  selector: 'app-tong-hop-phuong-an-gia-hai',
  templateUrl: './tong-hop-phuong-an-gia-hai.component.html',
  styleUrls: ['./tong-hop-phuong-an-gia-hai.component.scss']
})
export class TongHopPhuongAnGiaHaiComponent implements OnInit {
  @Output()
