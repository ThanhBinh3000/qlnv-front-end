...
@Component({
  selector: 'app-de-xuat-phuong-an-gia-hai',
  templateUrl: './de-xuat-phuong-an-gia-hai.component.html',
  styleUrls: ['./de-xuat-phuong-an-gia-hai.component.scss']
})
export class DeXuatPhuongAnGiaHaiComponent implements OnInit {
  @Output()
