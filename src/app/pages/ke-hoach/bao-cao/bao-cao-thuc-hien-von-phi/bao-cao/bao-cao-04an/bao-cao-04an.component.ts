...
export class BaoCao04anComponent implements OnInit {
    ...
    //tinh tong cong cac cot trong dot va luy ke
    getColTotal(id: any) {
        //luy ke default
    ...
    //kiểm tra các giá trị trong hàng có phải số lượng không
    checkNumber(maNdungChi: string) {
        if (maNdungChi == '0.1.1' || maNdungChi == '0.1.2' || maNdungChi == '0.1.3' || maNdungChi == '0.1.4') {
            return true;
        }
        return false;
    }
