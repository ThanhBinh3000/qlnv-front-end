...
export class BaoCao04bComponent implements OnInit {
    ...
    saveEdit(id: string): void {
        ...
        if (this.lstCtietBcao[index].maNdungChi != 13929 && this.lstCtietBcao[index].maNdungChi != 13930) {
        ...
        let index1: number;
        if (this.lstCtietBcao[index].maNdungChi == 13929) {
            index1 = this.lstCtietBcao.findIndex(e => e.maNdungChi == 13930);
        }
        if (this.lstCtietBcao[index].maNdungChi == 13930) {
            index1 = this.lstCtietBcao.findIndex(e => e.maNdungChi == 13939);
        }
        if ((index1 || index1 === 0) && index1 != -1) {
            const indexTong = this.lstCtietBcao.findIndex(e => e.maNdungChi == 13928);
    ...
    sum(stt: string) {
        ...
        while (stt != '0') {
            ...
            if (data.maNdungChi == 13886) {
                const ind1 = this.lstCtietBcao.findIndex(e => e.maNdungChi == 13928);
                const ind2 = this.lstCtietBcao.findIndex(e => e.maNdungChi == 13929);
                const ind3 = this.lstCtietBcao.findIndex(e => e.maNdungChi == 13930);
                if (ind1 != -1) {
