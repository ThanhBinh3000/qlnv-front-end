...
@Component({
  ...
  templateUrl: './mm-tt-phan-bo.component.html',
  styleUrls: ['./mm-tt-phan-bo.component.scss']
})
export class MmTtPhanBoComponent extends Base2Component implements OnInit {
