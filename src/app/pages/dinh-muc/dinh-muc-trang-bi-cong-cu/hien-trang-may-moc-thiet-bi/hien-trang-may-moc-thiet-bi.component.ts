...
@Component({
  selector: 'app-hien-trang-may-moc-thiet-bi',
  templateUrl: './hien-trang-may-moc-thiet-bi.component.html',
  styleUrls: ['./hien-trang-may-moc-thiet-bi.component.scss']
})
export class HienTrangMayMocThietBiComponent implements OnInit {
