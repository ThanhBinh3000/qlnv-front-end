...
@Component({
  selector: 'app-quyet-dinh-mua-sam',
  templateUrl: './quyet-dinh-mua-sam.component.html',
  styleUrls: ['./quyet-dinh-mua-sam.component.scss']
})
export class QuyetDinhMuaSamComponent implements OnInit {
