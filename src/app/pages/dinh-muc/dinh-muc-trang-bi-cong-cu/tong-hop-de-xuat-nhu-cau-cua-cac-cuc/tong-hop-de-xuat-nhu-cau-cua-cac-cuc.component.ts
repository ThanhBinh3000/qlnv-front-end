...
@Component({
  selector: 'app-tong-hop-de-xuat-nhu-cau-cua-cac-cuc',
  templateUrl: './tong-hop-de-xuat-nhu-cau-cua-cac-cuc.component.html',
  styleUrls: ['./tong-hop-de-xuat-nhu-cau-cua-cac-cuc.component.scss']
})
export class TongHopDeXuatNhuCauCuaCacCucComponent implements OnInit {
