...
@Component({
  ...
  templateUrl: './de-xuat-nc-chi-cuc-pvc.component.html',
  styleUrls: ['./de-xuat-nc-chi-cuc-pvc.component.scss']
})
export class DeXuatNcChiCucPvcComponent extends Base2Component implements OnInit {
