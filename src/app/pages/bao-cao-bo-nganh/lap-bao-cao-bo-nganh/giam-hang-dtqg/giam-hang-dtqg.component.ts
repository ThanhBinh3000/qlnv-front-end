...
@Component({
  selector: "app-giam-hang-dtqg",
  templateUrl: "./giam-hang-dtqg.component.html",
  styleUrls: ["./giam-hang-dtqg.component.scss"]
})
export class GiamHangDtqgComponent extends Base2Component implements OnInit {
  isView: boolean = true
  ...
  downloadPdf() {
    saveAs(this.pdfBlob, "bcbn_kh_giam_hang_du_tru_quoc_gia.pdf");
  }
