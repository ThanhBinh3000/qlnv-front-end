...
@Component({
  selector: "app-nhap-xuat-ton-kho-hang-dtqg",
  templateUrl: "./nhap-xuat-ton-kho-hang-dtqg.component.html",
  styleUrls: ["./nhap-xuat-ton-kho-hang-dtqg.component.scss"]
})
export class NhapXuatTonKhoHangDtqgComponent extends Base2Component implements OnInit {
  isView: boolean = true
  ...
  downloadPdf() {
    saveAs(this.pdfBlob, "bcbn_nhap_xuat_ton_kho_hang_dtqg.pdf");
  }
  ...
  async downloadExcel(id: any) {
    try {
      ...
      body.idHdr = id;
      body.typeFile = "xlsx";
      body.fileName = "bcbn_nhap_xuat_ton_kho_hang_dtqg.jrxml";
      ...
      await this.bcBnTt145Service.ketXuat(body).then(async s => {
        ...
        saveAs(this.excelBlob, "bcbn_nhap_xuat_ton_kho_hang_dtqg.xlsx");
      });
