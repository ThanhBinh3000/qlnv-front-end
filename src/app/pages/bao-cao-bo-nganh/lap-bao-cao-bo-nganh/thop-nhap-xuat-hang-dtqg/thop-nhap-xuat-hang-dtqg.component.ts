...
@Component({
  selector: "app-thop-nhap-xuat-hang-dtqg",
  templateUrl: "./thop-nhap-xuat-hang-dtqg.component.html",
  styleUrls: ["./thop-nhap-xuat-hang-dtqg.component.scss"]
})
export class ThopNhapXuatHangDTQGComponent extends Base2Component implements OnInit {
  isView: boolean = true
  ...
  downloadPdf() {
    saveAs(this.pdfBlob, "bcbn_kh_tong_hop_nhap_xuat_hang_dtqg.pdf");
  }
  ...
  async downloadExcel(id: any) {
    try {
      ...
      body.idHdr = id;
      body.typeFile = "xlsx";
      body.fileName = "bcbn_kh_tong_hop_nhap_xuat_hang_dtqg.jrxml";
      ...
      await this.bcBnTt145Service.ketXuat(body).then(async s => {
        ...
        saveAs(this.excelBlob, "bcbn_kh_tong_hop_nhap_xuat_hang_dtqg.xlsx");
      });
