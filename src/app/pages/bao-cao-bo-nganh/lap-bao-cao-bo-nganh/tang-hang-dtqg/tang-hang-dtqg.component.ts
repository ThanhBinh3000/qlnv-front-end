...
@Component({
  selector: "app-tang-hang-dtqg",
  templateUrl: "./tang-hang-dtqg.component.html",
  styleUrls: ["./tang-hang-dtqg.component.scss"]
})
export class TangHangDtqgComponent extends Base2Component implements OnInit {
  isView: boolean = true
