...
@Component({
  selector: "app-chi-tiet-nhap-xuat-ton-kho-hang-dtqg",
  templateUrl: "./chi-tiet-nhap-xuat-ton-kho-hang-dtqg.component.html",
  styleUrls: ["./chi-tiet-nhap-xuat-ton-kho-hang-dtqg.component.scss"]
})
export class ChiTietNhapXuatTonKhoHangDtqgComponent extends Base2Component implements OnInit {
  isView: boolean = true
  ...
  downloadPdf() {
    saveAs(this.pdfBlob, "bc_nhap_xuat_ton_kho_hang_dtqg.pdf");
  }
  ...
  async downloadExcel(id: any) {
    try {
      ...
      body.idHdr = id;
      body.typeFile = "xlsx";
      body.fileName = "bc_nhap_xuat_ton_kho_hang_dtqg.jrxml";
      body.tenBaoCao = "Báo cáo nhập, xuất, tồn kho hàng dự trự quốc gia";
      body.trangThai = "01";
      await this.bcBnTt145Service.ketXuat(body).then(async s => {
        this.excelBlob = s;
        this.excelSrc = await new Response(s).arrayBuffer();
        saveAs(this.excelBlob, "bc_nhap_xuat_ton_kho_hang_dtqg.xlsx");
      });
