...
@Component({
  ...
  templateUrl: './sl-gtri-hang-dtqg-xuat.component.html',
  styleUrls: ['./sl-gtri-hang-dtqg-xuat.component.scss']
})
export class SlGtriHangDtqgXuatComponent extends Base2Component implements OnInit {
  listQuy: any[] = [
    {text: 'Quý I', value: 1},
    {text: 'Quý II', value: 2},
