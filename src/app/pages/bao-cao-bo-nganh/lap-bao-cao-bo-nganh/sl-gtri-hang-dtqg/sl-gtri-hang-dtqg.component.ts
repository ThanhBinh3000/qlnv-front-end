...
@Component({
  ...
  templateUrl: './sl-gtri-hang-dtqg.component.html',
  styleUrls: ['./sl-gtri-hang-dtqg.component.scss']
})
export class SlGtriHangDtqgComponent extends Base2LocalComponent implements OnInit {
  listQuy: any[] = [
    {text: 'Quý I', value: 1},
    {text: 'Quý II', value: 2},
