...
@Component({
  selector: 'chi-tiet-don-vi-thuc-hien-quyet-dinh',
  templateUrl: './chi-tiet-don-vi-thuc-hien-quyet-dinh.component.html',
  styleUrls: ['./chi-tiet-don-vi-thuc-hien-quyet-dinh.component.scss'],
})
export class ChiTietDonViThucHienQuyetDinhComponent implements OnInit {
