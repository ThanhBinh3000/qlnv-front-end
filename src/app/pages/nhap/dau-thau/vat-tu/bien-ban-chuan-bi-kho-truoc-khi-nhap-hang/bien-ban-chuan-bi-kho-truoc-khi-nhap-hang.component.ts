...
@Component({
  selector: 'bien-ban-chuan-bi-kho-truoc-khi-nhap-hang',
  templateUrl: './bien-ban-chuan-bi-kho-truoc-khi-nhap-hang.component.html',
  styleUrls: ['./bien-ban-chuan-bi-kho-truoc-khi-nhap-hang.component.scss'],
})
export class BienBanChuanBiKhoTruocKhiNhapHangComponent implements OnInit {
  inputDonVi: string = '';
  options: any[] = [];
  optionsDonVi: any[] = [];
  ...
  redirectToChiTiet(id: number) {
    this.router.navigate([
      '/nhap/dau-thau/vat-tu/bien-ban-chuan-bi-kho-truoc-khi-nhap-hang/them-bien-ban-chuan-bi-kho-truoc-khi-nhap-hang',
      id,
    ]);
  }
