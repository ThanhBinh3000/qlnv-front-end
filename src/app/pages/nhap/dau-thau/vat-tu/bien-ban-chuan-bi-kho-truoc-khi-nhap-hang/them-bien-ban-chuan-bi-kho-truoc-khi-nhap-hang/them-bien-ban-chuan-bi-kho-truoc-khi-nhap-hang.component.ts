...
@Component({
  selector: 'them-bien-ban-chuan-bi-kho-truoc-khi-nhap-hang',
  templateUrl:
    './them-bien-ban-chuan-bi-kho-truoc-khi-nhap-hang.component.html',
  styleUrls: [
    './them-bien-ban-chuan-bi-kho-truoc-khi-nhap-hang.component.scss',
  ],
})
export class ThemBienBanChuanBiKhoTruocKhiNhapHangComponent implements OnInit {
  data: any;
  dataDetail: any;
  ...
  back() {
    this.router.navigate([
      'nhap/dau-thau/vat-tu/bien-ban-chuan-bi-kho-truoc-khi-nhap-hang',
    ]);
  }
}
