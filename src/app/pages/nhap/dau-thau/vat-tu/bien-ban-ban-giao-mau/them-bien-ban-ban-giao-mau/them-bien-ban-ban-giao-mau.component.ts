...
@Component({
  selector: 'them-bien-ban-ban-giao-mau',
  templateUrl: './them-bien-ban-ban-giao-mau.component.html',
  styleUrls: ['./them-bien-ban-ban-giao-mau.component.scss'],
})
export class ThemBienBanBanGiaoMauComponent implements OnInit {
  data: any;
  dataDetail: any;
