...
@Component({
  selector: 'bien-ban-ban-giao-mau',
  templateUrl: './bien-ban-ban-giao-mau.component.html',
  styleUrls: ['./bien-ban-ban-giao-mau.component.scss'],
})
export class BienBanBanGiaoMauComponent implements OnInit {
  inputDonVi: string = '';
  options: any[] = [];
  optionsDonVi: any[] = [];
  ...
  redirectToChiTiet(id: number) {
    this.router.navigate([
      '/nhap/dau-thau/vat-tu/bien-ban-ban-giao-mau/them-bien-ban-ban-giao-mau',
      id,
    ]);
  }
