...
@Component({
  selector: 'nhap-quyet-dinh',
  templateUrl: './nhap-quyet-dinh.component.html',
  styleUrls: ['./nhap-quyet-dinh.component.scss'],
})
export class NhapQuyetDinhComponent implements OnInit {
  searchValue = '';
  searchFilter = {
    soDeXuat: '',
  };
  ...
  back() {
    this.router.navigate([`/nhap/dau-thau/vat-tu/ke-hoach-lua-chon-nha-thau-vat-tu/du-thao-quyet-dinh`, this.id])
  }
