...
@Component({
  selector: 'quan-ly-bang-can-ke-hang',
  templateUrl: './quan-ly-bang-can-ke-hang.component.html',
  styleUrls: ['./quan-ly-bang-can-ke-hang.component.scss'],
})
export class QuanLyBangCanKeHangComponent implements OnInit {
  ...
  redirectToChiTiet(id: number) {
    this.router.navigate([
      '/nhap/dau-thau/vat-tu/quan-ly-bang-can-ke-hang/thong-tin-quan-ly-bang-can-ke-hang',
      id,
    ]);
  }
