...
@Component({
  selector: 'them-bien-ban-gui-hang',
  templateUrl: './them-bien-ban-gui-hang.component.html',
  styleUrls: ['./them-bien-ban-gui-hang.component.scss'],
})
export class ThemBienBanGuiHangComponent implements OnInit {
  data: any;
  dataDetail: any;
