...
@Component({
    selector: 'app-chi-tiet-bien-ban-ket-thuc-nhap-kho',
    templateUrl: './chi-tiet-bien-ban-ket-thuc-nhap-kho.component.html',
    styleUrls: ['./chi-tiet-bien-ban-ket-thuc-nhap-kho.component.scss']
})
