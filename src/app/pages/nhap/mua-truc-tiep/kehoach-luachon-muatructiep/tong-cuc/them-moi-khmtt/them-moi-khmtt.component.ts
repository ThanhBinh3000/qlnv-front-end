...
@Component({
  selector: 'app-them-moi-khmtt',
  templateUrl: './them-moi-khmtt.component.html',
  styleUrls: ['./them-moi-khmtt.component.scss']
})
export class ThemMoiKhmttComponent implements OnInit {
    ...
    modalTuChoi.afterClose.subscribe(async (text) => {
      if (text) {
        ...
        try {
          ...
          const res = await this.dxuatKhLcntVatTuService.approve(body);
          if (res.msg == MESSAGE.SUCCESS) {
