...
@Component({
    selector: "app-tong-hop-ke-hoach-tai-tong-cuc",
    templateUrl: "./tong-hop-dieu-chuyen-tai-tong-cuc.component.html",
    styleUrls: ["./tong-hop-dieu-chuyen-tai-tong-cuc.component.scss"]
})
export class TongHopDieuChuyenTaiTongCuc implements OnInit {
