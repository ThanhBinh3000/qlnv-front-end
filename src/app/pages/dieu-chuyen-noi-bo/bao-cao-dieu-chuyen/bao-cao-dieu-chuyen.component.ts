...
@Component({
    selector: "app-bao-cao-dieu-chuyen",
    templateUrl: "./bao-cao-dieu-chuyen.component.html",
    styleUrls: ["./bao-cao-dieu-chuyen.component.scss"]
})
export class BaoCaoDieuChuyenComponent implements OnInit {
