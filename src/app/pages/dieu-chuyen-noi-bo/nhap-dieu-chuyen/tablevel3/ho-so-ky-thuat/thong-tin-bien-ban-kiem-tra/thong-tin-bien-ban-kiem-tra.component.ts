...
@Component({
  selector: 'app-thong-tin-bien-ban-kiem-tra',
  templateUrl: './thong-tin-bien-ban-kiem-tra.component.html',
  styleUrls: ['./thong-tin-bien-ban-kiem-tra.component.scss']
})
export class ThongTinBienBanKiemTraComponent extends Base2Component implements OnInit {
