...
export interface PassDataPKNCL {
  ...
  thuKhoId: number, tenThuKho: string, donViTinh: string, keHoachDcDtlId: number, ngayHieuLuc: string
}
@Component({
...
export class PhieuKiemNghiemChatLuongXuatDieuChuyenComponent extends Base2Component implements OnInit {
  ...
  passData: PassDataPKNCL = {
    ...
    donViTinh: '', keHoachDcDtlId: null, ngayHieuLuc: ''
  };
  ...
  redirectToChiTiet(lv2: any, isView: boolean, bblayMauId?: number) {
    ...
    this.passData = {
      ...
      maHangHoa: lv2.maHangHoa, tenChLoaiHangHoa: lv2.tenChLoaiHangHoa, maChLoaiHangHoa: lv2.maChLoaiHangHoa, thuKhoId: lv2.thuKhoId, tenThuKho: lv2.thuKho, donViTinh: lv2.donViTinh, keHoachDcDtlId: lv2.keHoachDcDtlId, ngayHieuLuc: lv2.ngayHieuLucQd
    }
  }
  ...
  checkRoleAdd(trangThai: string): boolean {
    if (this.userService.isCuc() && !trangThai) {
      return true
    }
    return false
  }
