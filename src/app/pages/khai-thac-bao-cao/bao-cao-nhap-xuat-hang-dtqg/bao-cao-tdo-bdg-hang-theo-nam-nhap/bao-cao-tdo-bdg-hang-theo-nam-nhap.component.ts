...
@Component({
  selector: 'app-bao-cao-tdo-bdg-hang-theo-nam-nhap',
  templateUrl: './bao-cao-tdo-bdg-hang-theo-nam-nhap.component.html',
...
export class BaoCaoTdoBdgHangTheoNamNhapComponent  extends Base2Component implements OnInit  {
  ...
  pdfBlob: any;
  excelBlob: any;
  nameFile = "bao-cao-tien-do-bdg-thoc-theo-nam-nhap-va-ke-hoach";
