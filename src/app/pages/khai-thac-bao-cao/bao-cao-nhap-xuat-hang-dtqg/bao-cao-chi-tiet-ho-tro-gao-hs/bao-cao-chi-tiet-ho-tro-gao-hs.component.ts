...
@Component({
  selector: 'app-bao-cao-chi-tiet-ho-tro-gao-hs',
  templateUrl: './bao-cao-chi-tiet-ho-tro-gao-hs.component.html',
  styleUrls: ['./bao-cao-chi-tiet-ho-tro-gao-hs.component.scss']
})
export class BaoCaoChiTietHoTroGaoHsComponent extends Base2Component implements OnInit {
  pdfSrc: any;
  excelSrc: any;
  pdfBlob: any;
  excelBlob: any;
  nameFile = "chi-tiet-ho-tro-gao-hoc-sinh";
  ...
  async downloadExcel() {
    try {
      ...
      body.typeFile = "xlsx";
      await this.bcNhapXuatMuaBanHangDTQGService.chiTietHoTroGaoHocSinh(body).then(async s => {
        this.excelBlob = s;
