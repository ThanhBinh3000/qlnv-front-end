...
@Component({
  ...
  templateUrl: './th-bc-so-luong-cl-may-moc-thiet-bi-chuyen-dung.component.html',
  styleUrls: ['./th-bc-so-luong-cl-may-moc-thiet-bi-chuyen-dung.component.scss']
})
export class ThBcSoLuongClMayMocThietBiChuyenDungComponent extends Base2Component implements OnInit {
  pdfSrc: any;
  excelSrc: any;
  pdfBlob: any;
  excelBlob: any;
