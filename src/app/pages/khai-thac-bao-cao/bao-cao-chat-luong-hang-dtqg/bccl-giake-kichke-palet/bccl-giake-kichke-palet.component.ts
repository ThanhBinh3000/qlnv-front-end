...
@Component({
  selector: 'app-bccl-giake-kichke-palet',
  templateUrl: './bccl-giake-kichke-palet.component.html',
  styleUrls: ['./bccl-giake-kichke-palet.component.scss']
})
export class BcclGiakeKichkePaletComponent extends Base2Component implements OnInit {
  pdfSrc: any;
  excelSrc: any;
  pdfBlob: any;
  excelBlob: any;
