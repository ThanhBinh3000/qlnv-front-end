...
@Component({
  selector: 'app-them-moi-qd-sua-chua',
  templateUrl: './them-moi-qd-sua-chua.component.html',
  styleUrls: ['./them-moi-qd-sua-chua.component.scss']
})
export class ThemMoiQdSuaChuaComponent implements OnInit {
