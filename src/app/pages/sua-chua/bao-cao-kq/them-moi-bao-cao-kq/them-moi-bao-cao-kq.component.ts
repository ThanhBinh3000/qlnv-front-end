...
@Component({
  selector: 'app-them-moi-bao-cao-kq',
  templateUrl: './them-moi-bao-cao-kq.component.html',
  styleUrls: ['./them-moi-bao-cao-kq.component.scss']
})
export class ThemMoiBaoCaoKqComponent implements OnInit {
