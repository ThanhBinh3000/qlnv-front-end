...
@Component({
  selector: 'app-theo-doi-cap-von-mua-hang-dtqg-2',
  templateUrl: './theo-doi-cap-von-mua-hang-dtqg-2.component.html',
  styleUrls: ['./theo-doi-cap-von-mua-hang-dtqg-2.component.scss']
})
export class TheoDoiCapVonMuaHangDtqg2Component implements OnInit {
