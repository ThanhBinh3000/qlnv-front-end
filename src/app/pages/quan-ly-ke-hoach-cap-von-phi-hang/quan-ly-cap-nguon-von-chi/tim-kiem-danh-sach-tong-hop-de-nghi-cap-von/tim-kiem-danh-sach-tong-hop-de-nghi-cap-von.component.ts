...
@Component({
  ...
  templateUrl: './tim-kiem-danh-sach-tong-hop-de-nghi-cap-von.component.html',
  styleUrls: ['./tim-kiem-danh-sach-tong-hop-de-nghi-cap-von.component.scss'],
})
export class TimKiemDanhSachTongHopDeNghiCapVonComponent implements OnInit {
