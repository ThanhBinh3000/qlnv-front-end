...
export class ThanhToanChoKhachHangComponent implements OnInit {
    ...
    getStatusButton() {
        ...
        this.statusBtnDel = this.getBtnStatus(Utils.statusDelete, CVMB.DELETE_REPORT_TTKH, checkChirld);
        this.statusBtnSave = this.getBtnStatus(Utils.statusSave, CVMB.EDIT_REPORT_TTKH, checkChirld);
        this.statusBtnApprove = this.getBtnStatus(Utils.statusApprove, CVMB.APPROVE_REPORT_TTKH, checkChirld);
        this.statusBtnTBP = this.getBtnStatus(Utils.statusDuyet, CVMB.DUYET_REPORT_TTKH, checkChirld);
        this.statusBtnLD = this.getBtnStatus(Utils.statusPheDuyet, CVMB.PHE_DUYET_REPORT_TTKH, checkChirld);
        this.statusBtnCopy = this.getBtnStatus(Utils.statusCopy, CVMB.COPY_REPORT_TTKH, checkChirld);
    }
                ...
                async (data) => {
                    if (data.statusCode == 0) {
                        ...
                        this.router.navigate([
                            MAIN_ROUTE_CAPVON + '/' + CAP_VON_MUA_BAN + '/thanh-toan-cho-khach-hang/0/'
                            + data.data.id,
                        ]);
                    } else {
                        this.notification.error(MESSAGE.ERROR, data?.msg);
    ...
    close() {
        ...
        this.router.navigate([
            MAIN_ROUTE_CAPVON + '/' + CAP_VON_MUA_BAN + '/danh-sach-thanh-toan-cho-khach-hang/' + this.loai
        ]);
    }
