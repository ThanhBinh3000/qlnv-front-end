...
export class CapVonUngVonChoDonViCapDuoiComponent implements OnInit {
                ...
                async (data) => {
                    if (data.statusCode == 0) {
                        ...
                        this.router.navigate([
                            MAIN_ROUTE_CAPVON + '/' + CAP_VON_MUA_BAN + '/cap-von-ung-von-cho-don-vi-cap-duoi/0/' + data.data.id,
                        ])
                    } else {
                        this.notification.error(MESSAGE.ERROR, data?.msg);
                    }
    ...
    close() {
        ...
        this.router.navigate([
            MAIN_ROUTE_CAPVON + '/' + CAP_VON_MUA_BAN + '/danh-sach-cap-von-ung-von-cho-don-vi-cap-duoi/' + this.loai
        ])
    }
