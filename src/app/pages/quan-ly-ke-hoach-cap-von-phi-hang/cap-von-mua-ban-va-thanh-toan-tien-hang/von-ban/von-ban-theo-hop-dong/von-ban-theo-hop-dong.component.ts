...
@Component({
    selector: 'app-von-ban-theo-hop-dong',
    templateUrl: './von-ban-theo-hop-dong.component.html',
    styleUrls: ['../von-ban.component.scss'],
})
export class VonBanTheoHopDongComponent implements OnInit {
    @Input() dataInfo;
    ...
    getStatusButton() {
        ...
        if (this.statusGui) {
            this.scrollX = (400 + 11 * BOX_NUMBER_WIDTH).toString() + 'px';
        } else {
            this.scrollX = (350 + 11 * BOX_NUMBER_WIDTH).toString() + 'px';
        }
    }
