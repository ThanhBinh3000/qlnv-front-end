...
@Component({
    selector: 'app-danh-sach-ghi-nhan-cap-ung-von-tu-dvct',
    templateUrl: './danh-sach-ghi-nhan-cap-ung-von-tu-dvct.component.html',
    styleUrls: ['../../von-mua-von-ung.component.scss']
})
export class DanhSachGhiNhanCapUngVonTuDvctComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        this.statusNewReport = this.userService.isAccessPermisson(CVMB.ADD_REPORT_TC_GNV) || this.userService.isAccessPermisson(CVMB.ADD_REPORT_GNV);
