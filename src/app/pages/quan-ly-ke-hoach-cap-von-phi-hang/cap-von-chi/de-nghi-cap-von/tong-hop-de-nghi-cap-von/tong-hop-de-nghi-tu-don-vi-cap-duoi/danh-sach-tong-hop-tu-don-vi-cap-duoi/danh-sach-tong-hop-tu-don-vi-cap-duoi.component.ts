...
@Component({
  ...
  templateUrl: './danh-sach-tong-hop-tu-don-vi-cap-duoi.component.html',
  styleUrls: ['./danh-sach-tong-hop-tu-don-vi-cap-duoi.component.scss']
})
export class DanhSachTongHopTuDonViCapDuoiComponent implements OnInit {
  @Input() data;
