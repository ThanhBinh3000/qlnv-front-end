...
@Component({
    selector: 'app-cap-von-theo-hop-dong-trung-thau-vat-tu',
    templateUrl: './cap-von-theo-hop-dong-trung-thau-vat-tu.component.html',
    styleUrls: ['../de-nghi-cap-von-cac-don-vi.component.scss'],
})
export class CapVonTheoHopDongTrungThauVatTuComponent implements OnInit {
    @Input() dataInfo;
