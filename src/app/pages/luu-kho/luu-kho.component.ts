...
import { LUU_KHO_ROUTE_LIST } from './luu-kho.constant';
@Component({
    selector: 'app-luu-kho',
    templateUrl: './luu-kho.component.html',
    styleUrls: ['./luu-kho.component.scss'],
})
export class LuuKhoComponent implements OnInit, AfterViewInit {
    @ViewChild('myTab') myTab: ElementRef;
    routes = LUU_KHO_ROUTE_LIST;
    routerUrl: string = "";
