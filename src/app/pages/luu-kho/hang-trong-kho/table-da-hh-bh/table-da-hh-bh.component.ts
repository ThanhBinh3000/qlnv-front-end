...
@Component({
  selector: 'app-table-da-hh-bh',
  templateUrl: './table-da-hh-bh.component.html',
  styleUrls: ['./table-da-hh-bh.component.scss']
})
export class TableDaHhBhComponent extends Base3Component implements OnInit {
