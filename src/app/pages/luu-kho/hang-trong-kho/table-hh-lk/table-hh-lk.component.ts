...
@Component({
  selector: 'app-table-hh-lk',
  templateUrl: './table-hh-lk.component.html',
  styleUrls: ['./table-hh-lk.component.scss']
})
export class TableHhLkComponent extends Base3Component implements OnInit {
