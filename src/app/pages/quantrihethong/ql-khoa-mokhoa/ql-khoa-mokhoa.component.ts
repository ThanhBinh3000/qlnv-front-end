...
@Component({
  selector: 'app-ql-khoa-mokhoa',
  templateUrl: './ql-khoa-mokhoa.component.html',
  styleUrls: ['./ql-khoa-mokhoa.component.scss'],
})
export class QlKhoaMokhoaComponent implements OnInit {
