...
@Component({
  selector: 'app-them-ql-nhom-quyen',
  templateUrl: './them-ql-nhom-quyen.component.html',
  styleUrls: ['./them-ql-nhom-quyen.component.scss'],
})
export class ThemQlNhomQuyenComponent implements OnInit {
