...
import { ThemQlCMTSoComponent } from './them-ql-cmt-so/them-ql-cmt-so.component';


@Component({
  selector: 'app-ql-cmt-so',
  templateUrl: './ql-cmt-so.component.html',
  styleUrls: ['./ql-cmt-so.component.scss'],
})
export class QlCMTSOComponent implements OnInit {
