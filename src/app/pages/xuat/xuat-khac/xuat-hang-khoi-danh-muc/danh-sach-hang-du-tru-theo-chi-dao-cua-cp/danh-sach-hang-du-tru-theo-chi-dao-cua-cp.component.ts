...
@Component({
  ...
  templateUrl: './danh-sach-hang-du-tru-theo-chi-dao-cua-cp.component.html',
  styleUrls: ['./danh-sach-hang-du-tru-theo-chi-dao-cua-cp.component.scss']
})
export class DanhSachHangDuTruTheoChiDaoCuaCpComponent extends Base2Component implements OnInit {
  CHUC_NANG = CHUC_NANG;
  dsDonvi: any[] = [];
  dsLoaiVthh: any[] = [];
  dsCloaiVthh: any[] = [];
