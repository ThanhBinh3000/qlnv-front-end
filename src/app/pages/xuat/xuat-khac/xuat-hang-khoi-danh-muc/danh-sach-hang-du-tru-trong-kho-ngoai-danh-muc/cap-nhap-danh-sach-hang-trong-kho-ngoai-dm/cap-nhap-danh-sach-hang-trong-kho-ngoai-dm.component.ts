...
@Component({
  selector: 'app-cap-nhap-danh-sach-hang-trong-kho-ngoai-dm',
  templateUrl: './cap-nhap-danh-sach-hang-trong-kho-ngoai-dm.component.html',
  styleUrls: ['./cap-nhap-danh-sach-hang-trong-kho-ngoai-dm.component.scss']
})
export class CapNhapDanhSachHangTrongKhoNgoaiDmComponent extends Base2Component implements OnInit  {
