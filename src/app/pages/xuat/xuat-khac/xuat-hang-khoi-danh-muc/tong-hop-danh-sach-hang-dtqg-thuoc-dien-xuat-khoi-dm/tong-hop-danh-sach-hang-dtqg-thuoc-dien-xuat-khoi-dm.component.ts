...
@Component({
  selector: 'app-tong-hop-danh-sach-hang-dtqg-thuoc-dien-xuat-khoi-dm',
  templateUrl: './tong-hop-danh-sach-hang-dtqg-thuoc-dien-xuat-khoi-dm.component.html',
  styleUrls: ['./tong-hop-danh-sach-hang-dtqg-thuoc-dien-xuat-khoi-dm.component.scss']
})
export class TongHopDanhSachHangDtqgThuocDienXuatKhoiDmComponent extends Base2Component implements OnInit {
  CHUC_NANG = CHUC_NANG;
  dsDonvi: any[] = [];
  dsLoaiVthh: any[] = [];
  dsCloaiVthh: any[] = [];
    ...
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        try {
          ...
          this.tongHopDanhSachHangXkdmService.delete(body).then(async () => {
            await this.timKiem();
