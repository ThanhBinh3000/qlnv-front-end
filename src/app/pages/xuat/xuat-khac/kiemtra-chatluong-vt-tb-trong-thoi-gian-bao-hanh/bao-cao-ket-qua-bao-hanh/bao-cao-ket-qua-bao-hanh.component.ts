...
@Component({
  selector: 'app-bao-cao-ket-qua-bao-hanh',
  templateUrl: './bao-cao-ket-qua-bao-hanh.component.html',
  styleUrls: ['./bao-cao-ket-qua-bao-hanh.component.scss']
})
export class BaoCaoKetQuaBaoHanhComponent extends Base2Component implements OnInit {
