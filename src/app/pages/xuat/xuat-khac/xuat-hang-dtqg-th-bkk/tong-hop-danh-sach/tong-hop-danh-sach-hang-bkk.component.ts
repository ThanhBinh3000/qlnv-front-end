...
@Component({
  selector: 'app-tong-hop-danh-sach-hang-bkk',
  templateUrl: './tong-hop-danh-sach-hang-bkk.component.html',
  styleUrls: ['./tong-hop-danh-sach-hang-bkk.component.scss']
})
export class TongHopDanhSachHangBkkComponent  extends Base2Component implements OnInit  {
  CHUC_NANG = CHUC_NANG;
  dsDonvi: any[] = [];
  dsLoaiVthh: any[] = [];
  dsCloaiVthh: any[] = [];
