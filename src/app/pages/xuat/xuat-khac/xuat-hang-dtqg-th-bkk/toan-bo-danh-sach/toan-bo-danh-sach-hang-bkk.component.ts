...
import {
  DanhSachVttbXuatBatKhaKhangService
} from "../../../../../services/qlnv-hang/xuat-hang/xuatkhac/xuatvtbkk/DanhSachVttbXuatBatKhaKhang.service";

@Component({
  selector: 'app-toan-bo-danh-sach-hang-bkk',
...
export class ToanBoDanhSachHangBkkComponent extends Base2Component implements OnInit  {
  ...
  constructor(httpClient: HttpClient,
              ...
              private danhSachVttbXuatBatKhaKhangService: DanhSachVttbXuatBatKhaKhangService) {
    super(httpClient, storageService, notification, spinner, modal, danhSachVttbXuatBatKhaKhangService);
