...
@Component({
  selector: 'app-thong-tin-bang-ke-vat-tu',
  templateUrl: './thong-tin-bang-ke-vat-tu.component.html',
  styleUrls: ['./thong-tin-bang-ke-vat-tu.component.scss']
})
export class ThongTinBangKeVatTuComponent implements OnInit {
  @Input() id: number;
