...
@Component({
  selector: 'app-create-dai-dien',
  templateUrl: './create-dai-dien.component.html',
  styleUrls: ['./create-dai-dien.component.scss']
})
export class CreateDaiDienComponent implements OnInit {
