...
@Component({
  ...
  templateUrl: './them-moi-quyet-dinh-phe-duyet-kh-ban-dau-gia.component.html',
  styleUrls: ['./them-moi-quyet-dinh-phe-duyet-kh-ban-dau-gia.component.scss'],
})
export class ThemMoiQuyetDinhPheDuyetKhBanDauGiaComponent implements OnInit {
