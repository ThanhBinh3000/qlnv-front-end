...
@Component({
  selector: 'app-xtl-phieu-xk',
  templateUrl: './xtl-phieu-xk.component.html',
  styleUrls: ['./xtl-phieu-xk.component.scss']
})
export class XtlPhieuXkComponent extends Base3Component implements OnInit {
