...
@Component({
  ...
  templateUrl: './xtl-bb-tinh-kho.component.html',
  styleUrls: ['./xtl-bb-tinh-kho.component.scss']
})
export class XtlBbTinhKhoComponent extends Base3Component implements OnInit {
