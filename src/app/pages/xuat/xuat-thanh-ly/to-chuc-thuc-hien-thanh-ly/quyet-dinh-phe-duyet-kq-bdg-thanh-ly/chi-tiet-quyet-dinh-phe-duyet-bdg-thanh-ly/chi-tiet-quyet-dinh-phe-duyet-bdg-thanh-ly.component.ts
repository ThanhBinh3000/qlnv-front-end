...
} from "src/app/components/dialog/dialog-qd-xd-trung-han/dialog-qd-xd-trung-han.component";
...
export class ChiTietQuyetDinhPheDuyetBdgThanhLyComponent extends Base2Component implements OnInit {
  ...
  constructor(
    ...
    this.formData = this.fb.group({
      ...
      ngayKy: [],
      ngayHieuLuc: [],
      loaiHinhNhapXuat: ['Xuất bán đấu giá'],
      kieuNhapXuat: ['Xuất bán'],
      idThongBao: [],
      maThongBao: [],
      soBienBan: [],
      thongBaoKhongThanh: [],
