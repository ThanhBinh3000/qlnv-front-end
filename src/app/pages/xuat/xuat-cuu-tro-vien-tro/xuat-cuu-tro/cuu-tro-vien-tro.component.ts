...
export class CuuTroVienTroComponent implements OnInit {
  ...
  checkStatusPermission(data: any, action: any) {
    let mapQuyen = {
      XEM: [STATUS.DU_THAO, STATUS.DA_TAO_CBV, STATUS.CHO_DUYET_TP, STATUS.CHO_DUYET_LDV, STATUS.CHO_DUYET_LDC, STATUS.CHO_DUYET_LDCC, STATUS.DA_DUYET_LDV, STATUS.DA_DUYET_LDC, STATUS.DA_DUYET_LDCC, STATUS.TU_CHOI_TP, STATUS.TU_CHOI_LDC, STATUS.TU_CHOI_LDCC],
      ...
      XEM_NO: [STATUS.DU_THAO, STATUS.DA_TAO_CBV, STATUS.CHO_DUYET_TP, STATUS.CHO_DUYET_LDV, STATUS.CHO_DUYET_LDC, STATUS.CHO_DUYET_LDCC, STATUS.DA_DUYET_LDV, STATUS.DA_DUYET_LDC, STATUS.DA_DUYET_LDCC, STATUS.TU_CHOI_TP, STATUS.TU_CHOI_LDC, STATUS.TU_CHOI_LDCC],
      SUA_NO: [],
      XOA_NO: [],
