...
export class ThongBaoDauGiaTaiSanService extends BaseService {
  ...
  timKiem(body: any): Promise<any> {
    let url_ = `${environment.SERVICE_API}${this.GATEWAY}/thong-bao-ban-dau-gia?`;
    if (body.loaiVthh)
  ...
  deleteMultiple(body: any): Promise<any> {
    const url = `${environment.SERVICE_API}${this.GATEWAY}/thong-bao-ban-dau-gia/delete/multiple`;
